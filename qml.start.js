...
if (!_globals.src.Pages) /** @const */ _globals.src.Pages = {}
var $src$Pages = _globals.src.Pages
if (!_globals.src.UxAdvancedComponents) /** @const */ _globals.src.UxAdvancedComponents = {}
var $src$UxAdvancedComponents = _globals.src.UxAdvancedComponents
...
//=====[component src.UiStart]=====================

	var UiStartBaseComponent = $core.Item
	var UiStartBasePrototype = UiStartBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.Item}
 */
	var UiStartComponent = $src.UiStart = function(parent, row) {
		UiStartBaseComponent.apply(this, arguments)

	}
	var UiStartPrototype = UiStartComponent.prototype = Object.create(UiStartBasePrototype)

	UiStartPrototype.constructor = UiStartComponent

	UiStartPrototype.componentName = 'src.UiStart'

	UiStartPrototype.$c = function($c) {
		var $this = this;
		UiStartBasePrototype.$c.call(this, $c.$b = { })
var _this$child0 = new $src.Main($this)
		$c._this$child0 = _this$child0

//creating component Main
		_this$child0.$c($c.$c$_this$child0 = { })

		$this.addChild(_this$child0)
	}
	UiStartPrototype.$s = function($c) {
		var $this = this;
	UiStartBasePrototype.$s.call(this, $c.$b); delete $c.$b
//assigning anchors.fill to (${parent})
			$this.anchors._removeUpdater('fill'); $this.anchors.fill = ($this.parent);

//setting up component Main
...
//=====[component src.Main]=====================
	...
	var MainBaseComponent = $core.Item
	var MainBasePrototype = MainBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.Item}
 */
	var MainComponent = $src.Main = function(parent, row) {
		MainBaseComponent.apply(this, arguments)

	}
	var MainPrototype = MainComponent.prototype = Object.create(MainBasePrototype)

	MainPrototype.constructor = MainComponent

	MainPrototype.componentName = 'src.Main'
	core.addProperty(MainPrototype, 'bool', 'mobile')
	core.addProperty(MainPrototype, 'real', 'mainSize')

	MainPrototype.$c = function($c) {
		var $this = this;
		MainBasePrototype.$c.call(this, $c.$b = { })
var _this$child0 = new $src$Pages.StartPage($this)
		$c._this$child0 = _this$child0

//creating component StartPage
		_this$child0.$c($c.$c$_this$child0 = { })

		$this.addChild(_this$child0)
		$this._setId('window')
	}
	MainPrototype.$s = function($c) {
		var $this = this;
	MainBasePrototype.$s.call(this, $c.$b); delete $c.$b
//assigning anchors.fill to (${parent})
			$this.anchors._removeUpdater('fill'); $this.anchors.fill = ($this.parent);
//assigning mobile to (${width} < 800)
			$this._replaceUpdater('mobile', function() { $this.mobile = ($this.width < 800) }, [$this,'width'])
//assigning mainSize to (${width})
			$this._replaceUpdater('mainSize', function() { $this.mainSize = ($this.width) }, [$this,'width'])

//setting up component StartPage
			var _this$child0 = $c._this$child0
			_this$child0.$s($c.$c$_this$child0)
			delete $c.$c$_this$child0
...
//=====[component src.Pages.TemplatePage]=====================

	var TemplatePageBaseComponent = $core.Rectangle
	var TemplatePageBasePrototype = TemplatePageBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.Rectangle}
 */
	var TemplatePageComponent = $src$Pages.TemplatePage = function(parent, row) {
		TemplatePageBaseComponent.apply(this, arguments)

	}
	var TemplatePagePrototype = TemplatePageComponent.prototype = Object.create(TemplatePageBasePrototype)

	TemplatePagePrototype.constructor = TemplatePageComponent

	TemplatePagePrototype.componentName = 'src.Pages.TemplatePage'
	core.addProperty(TemplatePagePrototype, 'bool', 'mobile')
	core.addProperty(TemplatePagePrototype, 'string', 'mainColor', ("#055A85"))
	core.addProperty(TemplatePagePrototype, 'string', 'secondColor', ("#F18C16"))

	TemplatePagePrototype.$c = function($c) {
		var $this = this;
		TemplatePageBasePrototype.$c.call(this, $c.$b = { })
var _this$child0 = new $core.Flickable($this)
		$c._this$child0 = _this$child0

//creating component Flickable
		_this$child0.$c($c.$c$_this$child0 = { })
		var _this_child0$child0 = new $core.Item(_this$child0)
		$c._this_child0$child0 = _this_child0$child0

//creating component Item
		_this_child0$child0.$c($c.$c$_this_child0$child0 = { })
		var _this_child0_child0$child0 = new $core.Rectangle(_this_child0$child0)
		$c._this_child0_child0$child0 = _this_child0_child0$child0

//creating component Rectangle
		_this_child0_child0$child0.$c($c.$c$_this_child0_child0$child0 = { })
		var _this_child0_child0_child0$child0 = new $core.Rectangle(_this_child0_child0$child0)
		$c._this_child0_child0_child0$child0 = _this_child0_child0_child0$child0

//creating component Rectangle
		_this_child0_child0_child0$child0.$c($c.$c$_this_child0_child0_child0$child0 = { })
		var _this_child0_child0_child0_child0$child0 = new $core.Image(_this_child0_child0_child0$child0)
		$c._this_child0_child0_child0_child0$child0 = _this_child0_child0_child0_child0$child0

//creating component Image
		_this_child0_child0_child0_child0$child0.$c($c.$c$_this_child0_child0_child0_child0$child0 = { })
		_this_child0_child0_child0_child0$child0._setId('logoHeader')
		_this_child0_child0_child0$child0.addChild(_this_child0_child0_child0_child0$child0)
		var _this_child0_child0_child0_child0$child1 = new $core.MouseArea(_this_child0_child0_child0$child0)
		$c._this_child0_child0_child0_child0$child1 = _this_child0_child0_child0_child0$child1

//creating component MouseArea
		_this_child0_child0_child0_child0$child1.$c($c.$c$_this_child0_child0_child0_child0$child1 = { })

		_this_child0_child0_child0$child0.addChild(_this_child0_child0_child0_child0$child1)
		_this_child0_child0_child0$child0._setId('logoContainerHeader')
		_this_child0_child0$child0.addChild(_this_child0_child0_child0$child0)
		var _this_child0_child0_child0$child1 = new $core.Item(_this_child0_child0$child0)
		$c._this_child0_child0_child0$child1 = _this_child0_child0_child0$child1

//creating component Item
		_this_child0_child0_child0$child1.$c($c.$c$_this_child0_child0_child0$child1 = { })
		var _this_child0_child0_child0_child1$child0 = new $core.Text(_this_child0_child0_child0$child1)
		$c._this_child0_child0_child0_child1$child0 = _this_child0_child0_child0_child1$child0

//creating component Text
		_this_child0_child0_child0_child1$child0.$c($c.$c$_this_child0_child0_child0_child1$child0 = { })
		_this_child0_child0_child0_child1$child0._setId('loginText')
		_this_child0_child0_child0$child1.addChild(_this_child0_child0_child0_child1$child0)
		var _this_child0_child0_child0_child1$child1 = new $src$UxAdvancedComponents.UButton(_this_child0_child0_child0$child1)
		$c._this_child0_child0_child0_child1$child1 = _this_child0_child0_child0_child1$child1

//creating component UButton
		_this_child0_child0_child0_child1$child1.$c($c.$c$_this_child0_child0_child0_child1$child1 = { })
		_this_child0_child0_child0_child1$child1._setId('loginTextButton')
		_this_child0_child0_child0$child1.addChild(_this_child0_child0_child0_child1$child1)
		var _this_child0_child0_child0_child1$child2 = new $core.MouseArea(_this_child0_child0_child0$child1)
		$c._this_child0_child0_child0_child1$child2 = _this_child0_child0_child0_child1$child2

//creating component MouseArea
		_this_child0_child0_child0_child1$child2.$c($c.$c$_this_child0_child0_child0_child1$child2 = { })
		_this_child0_child0_child0_child1$child2._setId('loginMA')
		_this_child0_child0_child0$child1.addChild(_this_child0_child0_child0_child1$child2)
		var _this_child0_child0_child0_child1$child3 = new $core.Text(_this_child0_child0_child0$child1)
		$c._this_child0_child0_child0_child1$child3 = _this_child0_child0_child0_child1$child3

//creating component Text
		_this_child0_child0_child0_child1$child3.$c($c.$c$_this_child0_child0_child0_child1$child3 = { })
		_this_child0_child0_child0_child1$child3._setId('registrationText')
		_this_child0_child0_child0$child1.addChild(_this_child0_child0_child0_child1$child3)
		var _this_child0_child0_child0_child1$child4 = new $core.MouseArea(_this_child0_child0_child0$child1)
		$c._this_child0_child0_child0_child1$child4 = _this_child0_child0_child0_child1$child4

//creating component MouseArea
		_this_child0_child0_child0_child1$child4.$c($c.$c$_this_child0_child0_child0_child1$child4 = { })
		_this_child0_child0_child0_child1$child4._setId('registrationMA')
		_this_child0_child0_child0$child1.addChild(_this_child0_child0_child0_child1$child4)
		_this_child0_child0_child0$child1._setId('headerTextContainer')
		_this_child0_child0$child0.addChild(_this_child0_child0_child0$child1)
		_this_child0_child0$child0._setId('header')
		_this_child0$child0.addChild(_this_child0_child0$child0)
		var _this_child0_child0$child1 = new $core.Rectangle(_this_child0$child0)
		$c._this_child0_child0$child1 = _this_child0_child0$child1

//creating component Rectangle
		_this_child0_child0$child1.$c($c.$c$_this_child0_child0$child1 = { })
		var _this_child0_child0_child1$child0 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0$child1)
		$c._this_child0_child0_child1$child0 = _this_child0_child0_child1$child0

//creating component URoundButton
		_this_child0_child0_child1$child0.$c($c.$c$_this_child0_child0_child1$child0 = { })
		_this_child0_child0_child1$child0._setId('menuButton_top')
		_this_child0_child0$child1.addChild(_this_child0_child0_child1$child0)
		var _this_child0_child0_child1$child1 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0$child1)
		$c._this_child0_child0_child1$child1 = _this_child0_child0_child1$child1

//creating component URoundButton
		_this_child0_child0_child1$child1.$c($c.$c$_this_child0_child0_child1$child1 = { })
		_this_child0_child0_child1$child1._setId('searchButton_top')
		_this_child0_child0$child1.addChild(_this_child0_child0_child1$child1)
		var _this_child0_child0_child1$child2 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0$child1)
		$c._this_child0_child0_child1$child2 = _this_child0_child0_child1$child2

//creating component URoundButton
		_this_child0_child0_child1$child2.$c($c.$c$_this_child0_child0_child1$child2 = { })
		_this_child0_child0_child1$child2._setId('loginButton_top')
		_this_child0_child0$child1.addChild(_this_child0_child0_child1$child2)
		var _this_child0_child0_child1$child3 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0$child1)
		$c._this_child0_child0_child1$child3 = _this_child0_child0_child1$child3

//creating component URoundButton
		_this_child0_child0_child1$child3.$c($c.$c$_this_child0_child0_child1$child3 = { })
		_this_child0_child0_child1$child3._setId('emailButton_top')
		_this_child0_child0$child1.addChild(_this_child0_child0_child1$child3)
		_this_child0_child0$child1._setId('topPanel')
		_this_child0$child0.addChild(_this_child0_child0$child1)
		var _this_child0_child0$child2 = new $core.Rectangle(_this_child0$child0)
		$c._this_child0_child0$child2 = _this_child0_child0$child2

//creating component Rectangle
		_this_child0_child0$child2.$c($c.$c$_this_child0_child0$child2 = { })
		var _this_child0_child0_child2$child0 = new $core.MouseArea(_this_child0_child0$child2)
		$c._this_child0_child0_child2$child0 = _this_child0_child0_child2$child0

//creating component MouseArea
		_this_child0_child0_child2$child0.$c($c.$c$_this_child0_child0_child2$child0 = { })

		_this_child0_child0$child2.addChild(_this_child0_child0_child2$child0)
		var _this_child0_child0_child2$child1 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0$child2)
		$c._this_child0_child0_child2$child1 = _this_child0_child0_child2$child1

//creating component URoundButton
		_this_child0_child0_child2$child1.$c($c.$c$_this_child0_child0_child2$child1 = { })
	core.addProperty(_this_child0_child0_child2$child1, 'bool', 'openST', (false))
		_this_child0_child0_child2$child1._setId('menuButton')
		_this_child0_child0$child2.addChild(_this_child0_child0_child2$child1)
		var _this_child0_child0_child2$child2 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0$child2)
		$c._this_child0_child0_child2$child2 = _this_child0_child0_child2$child2

//creating component URoundButton
		_this_child0_child0_child2$child2.$c($c.$c$_this_child0_child0_child2$child2 = { })
	core.addProperty(_this_child0_child0_child2$child2, 'bool', 'openST', (false))
		_this_child0_child0_child2$child2._setId('searchButton')
		_this_child0_child0$child2.addChild(_this_child0_child0_child2$child2)
		var _this_child0_child0_child2$child3 = new $core.Column(_this_child0_child0$child2)
		$c._this_child0_child0_child2$child3 = _this_child0_child0_child2$child3

//creating component Column
		_this_child0_child0_child2$child3.$c($c.$c$_this_child0_child0_child2$child3 = { })
		var _this_child0_child0_child2_child3$child0 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0_child2$child3)
		$c._this_child0_child0_child2_child3$child0 = _this_child0_child0_child2_child3$child0

//creating component URoundButton
		_this_child0_child0_child2_child3$child0.$c($c.$c$_this_child0_child0_child2_child3$child0 = { })
		_this_child0_child0_child2_child3$child0._setId('vkButton')
		_this_child0_child0_child2$child3.addChild(_this_child0_child0_child2_child3$child0)
		var _this_child0_child0_child2_child3$child1 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0_child2$child3)
		$c._this_child0_child0_child2_child3$child1 = _this_child0_child0_child2_child3$child1

//creating component URoundButton
		_this_child0_child0_child2_child3$child1.$c($c.$c$_this_child0_child0_child2_child3$child1 = { })
		_this_child0_child0_child2_child3$child1._setId('facebookButton')
		_this_child0_child0_child2$child3.addChild(_this_child0_child0_child2_child3$child1)
		var _this_child0_child0_child2_child3$child2 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0_child2$child3)
		$c._this_child0_child0_child2_child3$child2 = _this_child0_child0_child2_child3$child2

//creating component URoundButton
		_this_child0_child0_child2_child3$child2.$c($c.$c$_this_child0_child0_child2_child3$child2 = { })
		_this_child0_child0_child2_child3$child2._setId('viberButton')
		_this_child0_child0_child2$child3.addChild(_this_child0_child0_child2_child3$child2)
		var _this_child0_child0_child2_child3$child3 = new $src$UxAdvancedComponents.URoundButton(_this_child0_child0_child2$child3)
		$c._this_child0_child0_child2_child3$child3 = _this_child0_child0_child2_child3$child3

//creating component URoundButton
		_this_child0_child0_child2_child3$child3.$c($c.$c$_this_child0_child0_child2_child3$child3 = { })
	core.addProperty(_this_child0_child0_child2_child3$child3, 'bool', 'openST', (false))
		_this_child0_child0_child2_child3$child3._setId('emailButton')
		_this_child0_child0_child2$child3.addChild(_this_child0_child0_child2_child3$child3)
		_this_child0_child0_child2$child3._setId('column')
		_this_child0_child0$child2.addChild(_this_child0_child0_child2$child3)
		_this_child0_child0$child2._setId('leftPanel')
		_this_child0$child0.addChild(_this_child0_child0$child2)
		var _this_child0_child0$child3 = new $core.Rectangle(_this_child0$child0)
		$c._this_child0_child0$child3 = _this_child0_child0$child3

//creating component Rectangle
		_this_child0_child0$child3.$c($c.$c$_this_child0_child0$child3 = { })
	core.addProperty(_this_child0_child0$child3, 'int', 'margin', (8))
	core.addProperty(_this_child0_child0$child3, 'int', 'desktopHeight', (100))
		var _this_child0_child0_child3$child0 = new $core.Rectangle(_this_child0_child0$child3)
		$c._this_child0_child0_child3$child0 = _this_child0_child0_child3$child0

//creating component Rectangle
		_this_child0_child0_child3$child0.$c($c.$c$_this_child0_child0_child3$child0 = { })
		var _this_child0_child0_child3_child0$child0 = new $core.Image(_this_child0_child0_child3$child0)
		$c._this_child0_child0_child3_child0$child0 = _this_child0_child0_child3_child0$child0

//creating component Image
		_this_child0_child0_child3_child0$child0.$c($c.$c$_this_child0_child0_child3_child0$child0 = { })
		_this_child0_child0_child3_child0$child0._setId('logoFooter')
		_this_child0_child0_child3$child0.addChild(_this_child0_child0_child3_child0$child0)
		var _this_child0_child0_child3_child0$child1 = new $core.MouseArea(_this_child0_child0_child3$child0)
		$c._this_child0_child0_child3_child0$child1 = _this_child0_child0_child3_child0$child1

//creating component MouseArea
		_this_child0_child0_child3_child0$child1.$c($c.$c$_this_child0_child0_child3_child0$child1 = { })

		_this_child0_child0_child3$child0.addChild(_this_child0_child0_child3_child0$child1)
		_this_child0_child0_child3$child0._setId('logoContainerFooter')
		_this_child0_child0$child3.addChild(_this_child0_child0_child3$child0)
		var _this_child0_child0_child3$child1 = new $core.Rectangle(_this_child0_child0$child3)
		$c._this_child0_child0_child3$child1 = _this_child0_child0_child3$child1

//creating component Rectangle
		_this_child0_child0_child3$child1.$c($c.$c$_this_child0_child0_child3$child1 = { })
	core.addProperty(_this_child0_child0_child3$child1, 'int', 'fontSize')
		var _this_child0_child0_child3_child1$child0 = new $core.Text(_this_child0_child0_child3$child1)
		$c._this_child0_child0_child3_child1$child0 = _this_child0_child0_child3_child1$child0

//creating component Text
		_this_child0_child0_child3_child1$child0.$c($c.$c$_this_child0_child0_child3_child1$child0 = { })
		_this_child0_child0_child3_child1$child0._setId('footerText1')
		_this_child0_child0_child3$child1.addChild(_this_child0_child0_child3_child1$child0)
		var _this_child0_child0_child3_child1$child1 = new $core.Text(_this_child0_child0_child3$child1)
		$c._this_child0_child0_child3_child1$child1 = _this_child0_child0_child3_child1$child1

//creating component Text
		_this_child0_child0_child3_child1$child1.$c($c.$c$_this_child0_child0_child3_child1$child1 = { })
		_this_child0_child0_child3_child1$child1._setId('footerText2')
		_this_child0_child0_child3$child1.addChild(_this_child0_child0_child3_child1$child1)
		_this_child0_child0_child3$child1._setId('footerTextContainer')
		_this_child0_child0$child3.addChild(_this_child0_child0_child3$child1)
		_this_child0_child0$child3._setId('footer')
		_this_child0$child0.addChild(_this_child0_child0$child3)
		_this_child0$child0._setId('mainSpace')
		_this$child0.addChild(_this_child0$child0)
		_this$child0._setId('flickable')
		$this.addChild(_this$child0)
		$this._setId('templatePage')
	}
	TemplatePagePrototype.$s = function($c) {
		var $this = this;
	TemplatePageBasePrototype.$s.call(this, $c.$b); delete $c.$b
//assigning width to (${window.width})
			$this._replaceUpdater('width', function() { $this.width = ($this._get('window').width) }, [$this._get('window'),'width'])
//assigning height to (${window.height})
			$this._replaceUpdater('height', function() { $this.height = ($this._get('window').height) }, [$this._get('window'),'height'])
//assigning mobile to (${window.mobile})
			$this._replaceUpdater('mobile', function() { $this.mobile = ($this._get('window').mobile) }, [$this._get('window'),'mobile'])

//setting up component Flickable
			var _this$child0 = $c._this$child0
			_this$child0.$s($c.$c$_this$child0)
			delete $c.$c$_this$child0
...
//assigning contentHeight to (${mainSpace.height})
			_this$child0._replaceUpdater('contentHeight', function() { _this$child0.contentHeight = (_this$child0._get('mainSpace').height) }, [_this$child0._get('mainSpace'),'height'])
//assigning contentWidth to (${parent.width})
			_this$child0._replaceUpdater('contentWidth', function() { _this$child0.contentWidth = (_this$child0.parent.width) }, [_this$child0.parent,'width'])
...
//assigning width to (${parent.width})
			_this_child0$child0._replaceUpdater('width', function() { _this_child0$child0.width = (_this_child0$child0.parent.width) }, [_this_child0$child0.parent,'width'])
//assigning height to (Math.max((${window.height}),(${header.height} + ${topPanel.height} + ${footer.height} + 20 + ! ${templatePage.mobile} * 40)))
			_this_child0$child0._replaceUpdater('height', function() { _this_child0$child0.height = (Math.max((_this_child0$child0._get('window').height),(_this_child0$child0._get('header').height + _this_child0$child0._get('topPanel').height + _this_child0$child0._get('footer').height + 20 + ! _this_child0$child0._get('templatePage').mobile * 40))) }, [_this_child0$child0._get('window'),'height',_this_child0$child0._get('header'),'height',_this_child0$child0._get('topPanel'),'height',_this_child0$child0._get('footer'),'height',_this_child0$child0._get('templatePage'),'mobile'])

//setting up component Rectangle
			var _this_child0_child0$child0 = $c._this_child0_child0$child0
			_this_child0_child0$child0.$s($c.$c$_this_child0_child0$child0)
			delete $c.$c$_this_child0_child0$child0

//assigning anchors.top to (${parent.top})
			_this_child0_child0$child0.anchors._replaceUpdater('top', function() { _this_child0_child0$child0.anchors.top = (_this_child0_child0$child0.parent.top) }, [_this_child0_child0$child0.parent,'top'])
//assigning anchors.left to (${leftPanel.right})
			_this_child0_child0$child0.anchors._replaceUpdater('left', function() { _this_child0_child0$child0.anchors.left = (_this_child0_child0$child0._get('leftPanel').right) }, [_this_child0_child0$child0._get('leftPanel'),'right'])
//assigning anchors.leftMargin to (${templatePage.mobile} ? 10 : ${templatePage.width} * 0.11)
			_this_child0_child0$child0.anchors._replaceUpdater('leftMargin', function() { _this_child0_child0$child0.anchors.leftMargin = (_this_child0_child0$child0._get('templatePage').mobile ? 10 : _this_child0_child0$child0._get('templatePage').width * 0.11) }, [_this_child0_child0$child0._get('templatePage'),'mobile',_this_child0_child0$child0._get('templatePage'),'width'])
//assigning width to (Math.floor(((${templatePage.width} - 2 * ${anchors.leftMargin} - ${leftPanel.width}) / 4)) * 4 < 0 ? 1000 : Math.floor(((${templatePage.width} - 2 * ${anchors.leftMargin} - ${leftPanel.width}) / 4)) * 4)
			_this_child0_child0$child0._replaceUpdater('width', function() { _this_child0_child0$child0.width = (Math.floor(((_this_child0_child0$child0._get('templatePage').width - 2 * _this_child0_child0$child0.anchors.leftMargin - _this_child0_child0$child0._get('leftPanel').width) / 4)) * 4 < 0 ? 1000 : Math.floor(((_this_child0_child0$child0._get('templatePage').width - 2 * _this_child0_child0$child0.anchors.leftMargin - _this_child0_child0$child0._get('leftPanel').width) / 4)) * 4) }, [_this_child0_child0$child0._get('templatePage'),'width',_this_child0_child0$child0.anchors,'leftMargin',_this_child0_child0$child0._get('leftPanel'),'width'])
//assigning height to (${templatePage.mobile} ? 0 : 100)
			_this_child0_child0$child0._replaceUpdater('height', function() { _this_child0_child0$child0.height = (_this_child0_child0$child0._get('templatePage').mobile ? 0 : 100) }, [_this_child0_child0$child0._get('templatePage'),'mobile'])
//assigning visible to (! ${templatePage.mobile})
			_this_child0_child0$child0._replaceUpdater('visible', function() { _this_child0_child0$child0.visible = (! _this_child0_child0$child0._get('templatePage').mobile) }, [_this_child0_child0$child0._get('templatePage'),'mobile'])

//setting up component Rectangle
			var _this_child0_child0_child0$child0 = $c._this_child0_child0_child0$child0
			_this_child0_child0_child0$child0.$s($c.$c$_this_child0_child0_child0$child0)
			delete $c.$c$_this_child0_child0_child0$child0

//assigning anchors.verticalCenter to (${parent.verticalCenter})
			_this_child0_child0_child0$child0.anchors._replaceUpdater('verticalCenter', function() { _this_child0_child0_child0$child0.anchors.verticalCenter = (_this_child0_child0_child0$child0.parent.verticalCenter) }, [_this_child0_child0_child0$child0.parent,'verticalCenter'])
//assigning height to (80)
			_this_child0_child0_child0$child0._removeUpdater('height'); _this_child0_child0_child0$child0.height = (80);
//assigning width to (250)
			_this_child0_child0_child0$child0._removeUpdater('width'); _this_child0_child0_child0$child0.width = (250);
//assigning color to ("transparent")
			_this_child0_child0_child0$child0._removeUpdater('color'); _this_child0_child0_child0$child0.color = ("transparent");

//setting up component Image
			var _this_child0_child0_child0_child0$child0 = $c._this_child0_child0_child0_child0$child0
			_this_child0_child0_child0_child0$child0.$s($c.$c$_this_child0_child0_child0_child0$child0)
			delete $c.$c$_this_child0_child0_child0_child0$child0

//assigning anchors.fill to (${parent})
			_this_child0_child0_child0_child0$child0.anchors._removeUpdater('fill'); _this_child0_child0_child0_child0$child0.anchors.fill = (_this_child0_child0_child0_child0$child0.parent);
//assigning fillMode to (_globals.core.Image.prototype.PreserveAspectFit)
			_this_child0_child0_child0_child0$child0._removeUpdater('fillMode'); _this_child0_child0_child0_child0$child0.fillMode = (_globals.core.Image.prototype.PreserveAspectFit);
//assigning source to ("Images/mainLogo.svg")
			_this_child0_child0_child0_child0$child0._removeUpdater('source'); _this_child0_child0_child0_child0$child0.source = ("Images/mainLogo.svg");

			_this_child0_child0_child0_child0$child0.completed()

//setting up component MouseArea
			var _this_child0_child0_child0_child0$child1 = $c._this_child0_child0_child0_child0$child1
			_this_child0_child0_child0_child0$child1.$s($c.$c$_this_child0_child0_child0_child0$child1)
			delete $c.$c$_this_child0_child0_child0_child0$child1

//assigning anchors.fill to (${parent})
			_this_child0_child0_child0_child0$child1.anchors._removeUpdater('fill'); _this_child0_child0_child0_child0$child1.anchors.fill = (_this_child0_child0_child0_child0$child1.parent);
//assigning enabled to (true)
			_this_child0_child0_child0_child0$child1._removeUpdater('enabled'); _this_child0_child0_child0_child0$child1.enabled = (true);
//assigning hoverEnabled to (${enabled})
			_this_child0_child0_child0_child0$child1._replaceUpdater('hoverEnabled', function() { _this_child0_child0_child0_child0$child1.hoverEnabled = (_this_child0_child0_child0_child0$child1.enabled) }, [_this_child0_child0_child0_child0$child1,'enabled'])
//assigning cursorShape to (${containsMouse} ? "pointer" : "default")
			_this_child0_child0_child0_child0$child1._replaceUpdater('cursorShape', function() { _this_child0_child0_child0_child0$child1.cursorShape = (_this_child0_child0_child0_child0$child1.containsMouse ? "pointer" : "default") }, [_this_child0_child0_child0_child0$child1,'containsMouse'])
			_this_child0_child0_child0_child0$child1.on('clicked', function() {
	var window = this._get('window', true)

                            changeSourceItem(window.homeURL)
                        }.bind(_this_child0_child0_child0_child0$child1))

			_this_child0_child0_child0_child0$child1.completed()

			_this_child0_child0_child0$child0.completed()

//setting up component Item
			var _this_child0_child0_child0$child1 = $c._this_child0_child0_child0$child1
			_this_child0_child0_child0$child1.$s($c.$c$_this_child0_child0_child0$child1)
			delete $c.$c$_this_child0_child0_child0$child1

//assigning anchors.right to (${parent.right})
			_this_child0_child0_child0$child1.anchors._replaceUpdater('right', function() { _this_child0_child0_child0$child1.anchors.right = (_this_child0_child0_child0$child1.parent.right) }, [_this_child0_child0_child0$child1.parent,'right'])
//assigning anchors.verticalCenter to (${parent.verticalCenter})
			_this_child0_child0_child0$child1.anchors._replaceUpdater('verticalCenter', function() { _this_child0_child0_child0$child1.anchors.verticalCenter = (_this_child0_child0_child0$child1.parent.verticalCenter) }, [_this_child0_child0_child0$child1.parent,'verticalCenter'])
//assigning height to (${parent.height} - 20)
			_this_child0_child0_child0$child1._replaceUpdater('height', function() { _this_child0_child0_child0$child1.height = (_this_child0_child0_child0$child1.parent.height - 20) }, [_this_child0_child0_child0$child1.parent,'height'])
//assigning width to (Math.max((${loginTextButton.width}),(${registrationText.width})))
			_this_child0_child0_child0$child1._replaceUpdater('width', function() { _this_child0_child0_child0$child1.width = (Math.max((_this_child0_child0_child0$child1._get('loginTextButton').width),(_this_child0_child0_child0$child1._get('registrationText').width))) }, [_this_child0_child0_child0$child1._get('loginTextButton'),'width',_this_child0_child0_child0$child1._get('registrationText'),'width'])

//setting up component Text
			var _this_child0_child0_child0_child1$child0 = $c._this_child0_child0_child0_child1$child0
			_this_child0_child0_child0_child1$child0.$s($c.$c$_this_child0_child0_child0_child1$child0)
			delete $c.$c$_this_child0_child0_child0_child1$child0

//assigning anchors.top to (${parent.top})
			_this_child0_child0_child0_child1$child0.anchors._replaceUpdater('top', function() { _this_child0_child0_child0_child1$child0.anchors.top = (_this_child0_child0_child0_child1$child0.parent.top) }, [_this_child0_child0_child0_child1$child0.parent,'top'])
//assigning anchors.left to (${parent.left})
			_this_child0_child0_child0_child1$child0.anchors._replaceUpdater('left', function() { _this_child0_child0_child0_child1$child0.anchors.left = (_this_child0_child0_child0_child1$child0.parent.left) }, [_this_child0_child0_child0_child1$child0.parent,'left'])
//assigning visible to (false)
			_this_child0_child0_child0_child1$child0._removeUpdater('visible'); _this_child0_child0_child0_child1$child0.visible = (false);
//assigning font.pixelSize to (${templatePage.width} > 1000 ? 20 : 20)
			_this_child0_child0_child0_child1$child0.font._replaceUpdater('pixelSize', function() { _this_child0_child0_child0_child1$child0.font.pixelSize = (_this_child0_child0_child0_child1$child0._get('templatePage').width > 1000 ? 20 : 20) }, [_this_child0_child0_child0_child1$child0._get('templatePage'),'width'])
//assigning font.family to (${templatePage.fontFamily})
			_this_child0_child0_child0_child1$child0.font._replaceUpdater('family', function() { _this_child0_child0_child0_child1$child0.font.family = (_this_child0_child0_child0_child1$child0._get('templatePage').fontFamily) }, [_this_child0_child0_child0_child1$child0._get('templatePage'),'fontFamily'])
//assigning font.underline to (${loginMA.containsMouse})
			_this_child0_child0_child0_child1$child0.font._replaceUpdater('underline', function() { _this_child0_child0_child0_child1$child0.font.underline = (_this_child0_child0_child0_child1$child0._get('loginMA').containsMouse) }, [_this_child0_child0_child0_child1$child0._get('loginMA'),'containsMouse'])
//assigning color to (${templatePage.mainColor})
			_this_child0_child0_child0_child1$child0._replaceUpdater('color', function() { _this_child0_child0_child0_child1$child0.color = (_this_child0_child0_child0_child1$child0._get('templatePage').mainColor) }, [_this_child0_child0_child0_child1$child0._get('templatePage'),'mainColor'])
//assigning text to ("Вход в личный кабинет")
			_this_child0_child0_child0_child1$child0._removeUpdater('text'); _this_child0_child0_child0_child1$child0.text = ("Вход в личный кабинет");

			_this_child0_child0_child0_child1$child0.completed()

//setting up component UButton
			var _this_child0_child0_child0_child1$child1 = $c._this_child0_child0_child0_child1$child1
			_this_child0_child0_child0_child1$child1.$s($c.$c$_this_child0_child0_child0_child1$child1)
			delete $c.$c$_this_child0_child0_child0_child1$child1

//assigning anchors.left to (${loginText.left})
			_this_child0_child0_child0_child1$child1.anchors._replaceUpdater('left', function() { _this_child0_child0_child0_child1$child1.anchors.left = (_this_child0_child0_child0_child1$child1._get('loginText').left) }, [_this_child0_child0_child0_child1$child1._get('loginText'),'left'])
//assigning anchors.top to (${loginText.top})
			_this_child0_child0_child0_child1$child1.anchors._replaceUpdater('top', function() { _this_child0_child0_child0_child1$child1.anchors.top = (_this_child0_child0_child0_child1$child1._get('loginText').top) }, [_this_child0_child0_child0_child1$child1._get('loginText'),'top'])
//assigning width to (${textWidth} + 40)
			_this_child0_child0_child0_child1$child1._replaceUpdater('width', function() { _this_child0_child0_child0_child1$child1.width = (_this_child0_child0_child0_child1$child1.textWidth + 40) }, [_this_child0_child0_child0_child1$child1,'textWidth'])
//assigning height to (${textHeight} + 20)
			_this_child0_child0_child0_child1$child1._replaceUpdater('height', function() { _this_child0_child0_child0_child1$child1.height = (_this_child0_child0_child0_child1$child1.textHeight + 20) }, [_this_child0_child0_child0_child1$child1,'textHeight'])
//assigning radius to (10)
			_this_child0_child0_child0_child1$child1._removeUpdater('radius'); _this_child0_child0_child0_child1$child1.radius = (10);
//assigning text to (${loginText.text})
			_this_child0_child0_child0_child1$child1._replaceUpdater('text', function() { _this_child0_child0_child0_child1$child1.text = (_this_child0_child0_child0_child1$child1._get('loginText').text) }, [_this_child0_child0_child0_child1$child1._get('loginText'),'text'])
//assigning font to (${loginText.font.pixelSize})
			_this_child0_child0_child0_child1$child1._replaceUpdater('font', function() { _this_child0_child0_child0_child1$child1.font = (_this_child0_child0_child0_child1$child1._get('loginText').font.pixelSize) }, [_this_child0_child0_child0_child1$child1._get('loginText').font,'pixelSize'])
//assigning fontFamily to (${templatePage.fontFamily})
			_this_child0_child0_child0_child1$child1._replaceUpdater('fontFamily', function() { _this_child0_child0_child0_child1$child1.fontFamily = (_this_child0_child0_child0_child1$child1._get('templatePage').fontFamily) }, [_this_child0_child0_child0_child1$child1._get('templatePage'),'fontFamily'])
//assigning fontBold to (false)
			_this_child0_child0_child0_child1$child1._removeUpdater('fontBold'); _this_child0_child0_child0_child1$child1.fontBold = (false);
			_this_child0_child0_child0_child1$child1.on('clicked', function() {
	var templatePage = this._get('templatePage', true)

                            loginDialog.show()
                            templatePage.loginSignal()
                        }.bind(_this_child0_child0_child0_child1$child1))

			_this_child0_child0_child0_child1$child1.completed()

//setting up component MouseArea
			var _this_child0_child0_child0_child1$child2 = $c._this_child0_child0_child0_child1$child2
			_this_child0_child0_child0_child1$child2.$s($c.$c$_this_child0_child0_child0_child1$child2)
			delete $c.$c$_this_child0_child0_child0_child1$child2

//assigning anchors.fill to (${loginTextButton})
			_this_child0_child0_child0_child1$child2.anchors._replaceUpdater('fill', function() { _this_child0_child0_child0_child1$child2.anchors.fill = (_this_child0_child0_child0_child1$child2._get('loginTextButton')) }, [_this_child0_child0_child0_child1$child2,'loginTextButton'])
//assigning enabled to (false)
			_this_child0_child0_child0_child1$child2._removeUpdater('enabled'); _this_child0_child0_child0_child1$child2.enabled = (false);
//assigning hoverEnabled to (${enabled})
			_this_child0_child0_child0_child1$child2._replaceUpdater('hoverEnabled', function() { _this_child0_child0_child0_child1$child2.hoverEnabled = (_this_child0_child0_child0_child1$child2.enabled) }, [_this_child0_child0_child0_child1$child2,'enabled'])
//assigning cursorShape to (${containsMouse} ? "pointer" : "default")
			_this_child0_child0_child0_child1$child2._replaceUpdater('cursorShape', function() { _this_child0_child0_child0_child1$child2.cursorShape = (_this_child0_child0_child0_child1$child2.containsMouse ? "pointer" : "default") }, [_this_child0_child0_child0_child1$child2,'containsMouse'])
			_this_child0_child0_child0_child1$child2.on('clicked', function() {
	var templatePage = this._get('templatePage', true)

                            loginDialog.show()
                            templatePage.loginSignal()
                        }.bind(_this_child0_child0_child0_child1$child2))

			_this_child0_child0_child0_child1$child2.completed()

//setting up component Text
			var _this_child0_child0_child0_child1$child3 = $c._this_child0_child0_child0_child1$child3
			_this_child0_child0_child0_child1$child3.$s($c.$c$_this_child0_child0_child0_child1$child3)
			delete $c.$c$_this_child0_child0_child0_child1$child3

//assigning anchors.bottom to (${parent.bottom})
			_this_child0_child0_child0_child1$child3.anchors._replaceUpdater('bottom', function() { _this_child0_child0_child0_child1$child3.anchors.bottom = (_this_child0_child0_child0_child1$child3.parent.bottom) }, [_this_child0_child0_child0_child1$child3.parent,'bottom'])
//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child0_child1$child3.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child0_child1$child3.anchors.horizontalCenter = (_this_child0_child0_child0_child1$child3.parent.horizontalCenter) }, [_this_child0_child0_child0_child1$child3.parent,'horizontalCenter'])
//assigning font.pixelSize to (${templatePage.width} > 1000 ? 20 : 20)
			_this_child0_child0_child0_child1$child3.font._replaceUpdater('pixelSize', function() { _this_child0_child0_child0_child1$child3.font.pixelSize = (_this_child0_child0_child0_child1$child3._get('templatePage').width > 1000 ? 20 : 20) }, [_this_child0_child0_child0_child1$child3._get('templatePage'),'width'])
//assigning font.family to (${templatePage.fontFamily})
			_this_child0_child0_child0_child1$child3.font._replaceUpdater('family', function() { _this_child0_child0_child0_child1$child3.font.family = (_this_child0_child0_child0_child1$child3._get('templatePage').fontFamily) }, [_this_child0_child0_child0_child1$child3._get('templatePage'),'fontFamily'])
//assigning font.underline to (${registrationMA.containsMouse})
			_this_child0_child0_child0_child1$child3.font._replaceUpdater('underline', function() { _this_child0_child0_child0_child1$child3.font.underline = (_this_child0_child0_child0_child1$child3._get('registrationMA').containsMouse) }, [_this_child0_child0_child0_child1$child3._get('registrationMA'),'containsMouse'])
//assigning color to (${templatePage.mainColor})
			_this_child0_child0_child0_child1$child3._replaceUpdater('color', function() { _this_child0_child0_child0_child1$child3.color = (_this_child0_child0_child0_child1$child3._get('templatePage').mainColor) }, [_this_child0_child0_child0_child1$child3._get('templatePage'),'mainColor'])
//assigning text to ("Регистрация")
			_this_child0_child0_child0_child1$child3._removeUpdater('text'); _this_child0_child0_child0_child1$child3.text = ("Регистрация");

			_this_child0_child0_child0_child1$child3.completed()

//setting up component MouseArea
			var _this_child0_child0_child0_child1$child4 = $c._this_child0_child0_child0_child1$child4
			_this_child0_child0_child0_child1$child4.$s($c.$c$_this_child0_child0_child0_child1$child4)
			delete $c.$c$_this_child0_child0_child0_child1$child4

//assigning anchors.fill to (${registrationText})
			_this_child0_child0_child0_child1$child4.anchors._replaceUpdater('fill', function() { _this_child0_child0_child0_child1$child4.anchors.fill = (_this_child0_child0_child0_child1$child4._get('registrationText')) }, [_this_child0_child0_child0_child1$child4,'registrationText'])
//assigning enabled to (${templatePage.visible} && ${header.visible})
			_this_child0_child0_child0_child1$child4._replaceUpdater('enabled', function() { _this_child0_child0_child0_child1$child4.enabled = (_this_child0_child0_child0_child1$child4._get('templatePage').visible && _this_child0_child0_child0_child1$child4._get('header').visible) }, [_this_child0_child0_child0_child1$child4._get('templatePage'),'visible',_this_child0_child0_child0_child1$child4._get('header'),'visible'])
//assigning hoverEnabled to (${enabled})
			_this_child0_child0_child0_child1$child4._replaceUpdater('hoverEnabled', function() { _this_child0_child0_child0_child1$child4.hoverEnabled = (_this_child0_child0_child0_child1$child4.enabled) }, [_this_child0_child0_child0_child1$child4,'enabled'])
//assigning cursorShape to (${containsMouse} ? "pointer" : "default")
			_this_child0_child0_child0_child1$child4._replaceUpdater('cursorShape', function() { _this_child0_child0_child0_child1$child4.cursorShape = (_this_child0_child0_child0_child1$child4.containsMouse ? "pointer" : "default") }, [_this_child0_child0_child0_child1$child4,'containsMouse'])
			_this_child0_child0_child0_child1$child4.on('clicked', function() {
	var templatePage = this._get('templatePage', true), headerTextContainer = this._get('headerTextContainer', true), header = this._get('header', true), leftPanel = this._get('leftPanel', true), registrationMA = this._get('registrationMA', true)

                            //templatePage.registrationSignal()
                            registrationWindow.startX  = mapToItem(templatePage, mouse.x, mouse.y).x
                            registrationWindow.startY  = mapToItem(templatePage, mouse.x, mouse.y).y
                            //КОСТЫЛЬ!!! НЕ РАБОТАЕТ КОРРЕКТНО mapToItem (НА НЕСКОЛЬКО УРОВНЕЙ ВВЕРХ)
                            //                            registrationWindow.startX  =  mouse.x + headerTextContainer.x + header.anchors.leftMargin + leftPanel.width
                            //                            registrationWindow.startY  =  mouse.y + headerTextContainer.y + registrationMA.y
                            registrationWindow.show()
                        }.bind(_this_child0_child0_child0_child1$child4))

			_this_child0_child0_child0_child1$child4.completed()

			_this_child0_child0_child0$child1.completed()

			_this_child0_child0$child0.completed()

//setting up component Rectangle
			var _this_child0_child0$child1 = $c._this_child0_child0$child1
			_this_child0_child0$child1.$s($c.$c$_this_child0_child0$child1)
			delete $c.$c$_this_child0_child0$child1

//assigning anchors.top to (${parent.top})
			_this_child0_child0$child1.anchors._replaceUpdater('top', function() { _this_child0_child0$child1.anchors.top = (_this_child0_child0$child1.parent.top) }, [_this_child0_child0$child1.parent,'top'])
//assigning anchors.left to (${parent.left})
			_this_child0_child0$child1.anchors._replaceUpdater('left', function() { _this_child0_child0$child1.anchors.left = (_this_child0_child0$child1.parent.left) }, [_this_child0_child0$child1.parent,'left'])
//assigning anchors.right to (${parent.right})
			_this_child0_child0$child1.anchors._replaceUpdater('right', function() { _this_child0_child0$child1.anchors.right = (_this_child0_child0$child1.parent.right) }, [_this_child0_child0$child1.parent,'right'])
//assigning height to (${visible} ? 50 : 0)
			_this_child0_child0$child1._replaceUpdater('height', function() { _this_child0_child0$child1.height = (_this_child0_child0$child1.visible ? 50 : 0) }, [_this_child0_child0$child1,'visible'])
//assigning color to (${templatePage.mainColor})
			_this_child0_child0$child1._replaceUpdater('color', function() { _this_child0_child0$child1.color = (_this_child0_child0$child1._get('templatePage').mainColor) }, [_this_child0_child0$child1._get('templatePage'),'mainColor'])
//assigning visible to (${templatePage.mobile})
			_this_child0_child0$child1._replaceUpdater('visible', function() { _this_child0_child0$child1.visible = (_this_child0_child0$child1._get('templatePage').mobile) }, [_this_child0_child0$child1._get('templatePage'),'mobile'])

//setting up component URoundButton
			var _this_child0_child0_child1$child0 = $c._this_child0_child0_child1$child0
			_this_child0_child0_child1$child0.$s($c.$c$_this_child0_child0_child1$child0)
			delete $c.$c$_this_child0_child0_child1$child0

//assigning anchors.left to (${parent.left})
			_this_child0_child0_child1$child0.anchors._replaceUpdater('left', function() { _this_child0_child0_child1$child0.anchors.left = (_this_child0_child0_child1$child0.parent.left) }, [_this_child0_child0_child1$child0.parent,'left'])
//assigning anchors.leftMargin to (20)
			_this_child0_child0_child1$child0.anchors._removeUpdater('leftMargin'); _this_child0_child0_child1$child0.anchors.leftMargin = (20);
//assigning anchors.verticalCenter to (${parent.verticalCenter})
			_this_child0_child0_child1$child0.anchors._replaceUpdater('verticalCenter', function() { _this_child0_child0_child1$child0.anchors.verticalCenter = (_this_child0_child0_child1$child0.parent.verticalCenter) }, [_this_child0_child0_child1$child0.parent,'verticalCenter'])
//assigning anchors.top to (${parent.top})
			_this_child0_child0_child1$child0.anchors._replaceUpdater('top', function() { _this_child0_child0_child1$child0.anchors.top = (_this_child0_child0_child1$child0.parent.top) }, [_this_child0_child0_child1$child0.parent,'top'])
//assigning imageSource to (! ${menuButton_top.openST} ? "Icons/menu.svg" : "Icons/whiteCross2.svg")
			_this_child0_child0_child1$child0._replaceUpdater('imageSource', function() { _this_child0_child0_child1$child0.imageSource = (! _this_child0_child0_child1$child0._get('menuButton_top').openST ? "Icons/menu.svg" : "Icons/whiteCross2.svg") }, [_this_child0_child0_child1$child0._get('menuButton_top'),'openST'])
//assigning radius to (${parent.height} / 1.8)
			_this_child0_child0_child1$child0._replaceUpdater('radius', function() { _this_child0_child0_child1$child0.radius = (_this_child0_child0_child1$child0.parent.height / 1.8) }, [_this_child0_child0_child1$child0.parent,'height'])
//assigning color to (${topPanel.color})
			_this_child0_child0_child1$child0._replaceUpdater('color', function() { _this_child0_child0_child1$child0.color = (_this_child0_child0_child1$child0._get('topPanel').color) }, [_this_child0_child0_child1$child0._get('topPanel'),'color'])
//assigning enabled to (${topPanel.visible})
			_this_child0_child0_child1$child0._replaceUpdater('enabled', function() { _this_child0_child0_child1$child0.enabled = (_this_child0_child0_child1$child0._get('topPanel').visible) }, [_this_child0_child0_child1$child0._get('topPanel'),'visible'])
			_this_child0_child0_child1$child0.on('clicked', function() {
	var templatePage = this._get('templatePage', true)

                        if(!menuSpace.openST)
                            menuSpace.openST = true
                        else if (openST)
                            menuSpace.openST = false

                        //                        menuSpace.isMenuList = true
                        //                        menuSpace.isQuestionSearch = false
                        //                        menuSpace.isSendingMesage = false
                        //                        menuSpace.isLogin = false
                        menuSpace.menuMode = "isMenuList"

                        templatePage.menuSignal()
                    }.bind(_this_child0_child0_child1$child0))

			_this_child0_child0_child1$child0.completed()

//setting up component URoundButton
			var _this_child0_child0_child1$child1 = $c._this_child0_child0_child1$child1
			_this_child0_child0_child1$child1.$s($c.$c$_this_child0_child0_child1$child1)
			delete $c.$c$_this_child0_child0_child1$child1

//assigning anchors.verticalCenter to (${parent.verticalCenter})
			_this_child0_child0_child1$child1.anchors._replaceUpdater('verticalCenter', function() { _this_child0_child0_child1$child1.anchors.verticalCenter = (_this_child0_child0_child1$child1.parent.verticalCenter) }, [_this_child0_child0_child1$child1.parent,'verticalCenter'])
//assigning anchors.right to (${parent.right})
			_this_child0_child0_child1$child1.anchors._replaceUpdater('right', function() { _this_child0_child0_child1$child1.anchors.right = (_this_child0_child0_child1$child1.parent.right) }, [_this_child0_child0_child1$child1.parent,'right'])
//assigning anchors.rightMargin to (20)
			_this_child0_child0_child1$child1.anchors._removeUpdater('rightMargin'); _this_child0_child0_child1$child1.anchors.rightMargin = (20);
//assigning imageSource to (! ${searchButton_top.openST} ? "Icons/search.svg" : "Icons/whiteCross2.svg")
			_this_child0_child0_child1$child1._replaceUpdater('imageSource', function() { _this_child0_child0_child1$child1.imageSource = (! _this_child0_child0_child1$child1._get('searchButton_top').openST ? "Icons/search.svg" : "Icons/whiteCross2.svg") }, [_this_child0_child0_child1$child1._get('searchButton_top'),'openST'])
//assigning radius to (${parent.height} / 1.8)
			_this_child0_child0_child1$child1._replaceUpdater('radius', function() { _this_child0_child0_child1$child1.radius = (_this_child0_child0_child1$child1.parent.height / 1.8) }, [_this_child0_child0_child1$child1.parent,'height'])
//assigning color to (${topPanel.color})
			_this_child0_child0_child1$child1._replaceUpdater('color', function() { _this_child0_child0_child1$child1.color = (_this_child0_child0_child1$child1._get('topPanel').color) }, [_this_child0_child0_child1$child1._get('topPanel'),'color'])
//assigning enabled to (${topPanel.visible})
			_this_child0_child0_child1$child1._replaceUpdater('enabled', function() { _this_child0_child0_child1$child1.enabled = (_this_child0_child0_child1$child1._get('topPanel').visible) }, [_this_child0_child0_child1$child1._get('topPanel'),'visible'])
			_this_child0_child0_child1$child1.on('clicked', function() {
	var templatePage = this._get('templatePage', true)
                        ...
                        //                        menuSpace.isMenuList = false
                        //                        menuSpace.isQuestionSearch = true
                        //                        menuSpace.isSendingMesage = false
                        //                        menuSpace.isLogin = false

                        menuSpace.menuMode = "isQuestionSearch"

                        templatePage.searchSignal()
                    }.bind(_this_child0_child0_child1$child1))

			_this_child0_child0_child1$child1.completed()

//setting up component URoundButton
			var _this_child0_child0_child1$child2 = $c._this_child0_child0_child1$child2
			_this_child0_child0_child1$child2.$s($c.$c$_this_child0_child0_child1$child2)
			delete $c.$c$_this_child0_child0_child1$child2

//assigning anchors.verticalCenter to (${parent.verticalCenter})
			_this_child0_child0_child1$child2.anchors._replaceUpdater('verticalCenter', function() { _this_child0_child0_child1$child2.anchors.verticalCenter = (_this_child0_child0_child1$child2.parent.verticalCenter) }, [_this_child0_child0_child1$child2.parent,'verticalCenter'])
//assigning anchors.left to (${menuButton_top.right})
			_this_child0_child0_child1$child2.anchors._replaceUpdater('left', function() { _this_child0_child0_child1$child2.anchors.left = (_this_child0_child0_child1$child2._get('menuButton_top').right) }, [_this_child0_child0_child1$child2._get('menuButton_top'),'right'])
//assigning anchors.leftMargin to ((${parent.width} - 2 * (1 + 0.5) * ${menuButton_top.width} - 2 * ${menuButton_top.anchors.leftMargin}) / 3 - ${width} / 3)
			_this_child0_child0_child1$child2.anchors._replaceUpdater('leftMargin', function() { _this_child0_child0_child1$child2.anchors.leftMargin = ((_this_child0_child0_child1$child2.parent.width - 2 * (1 + 0.5) * _this_child0_child0_child1$child2._get('menuButton_top').width - 2 * _this_child0_child0_child1$child2._get('menuButton_top').anchors.leftMargin) / 3 - _this_child0_child0_child1$child2.width / 3) }, [_this_child0_child0_child1$child2.parent,'width',_this_child0_child0_child1$child2._get('menuButton_top'),'width',_this_child0_child0_child1$child2._get('menuButton_top').anchors,'leftMargin',_this_child0_child0_child1$child2,'width'])
//assigning imageSource to (! ${loginButton_top.openST} ? "Icons/account.svg" : "Icons/whiteCross2.svg")
			_this_child0_child0_child1$child2._replaceUpdater('imageSource', function() { _this_child0_child0_child1$child2.imageSource = (! _this_child0_child0_child1$child2._get('loginButton_top').openST ? "Icons/account.svg" : "Icons/whiteCross2.svg") }, [_this_child0_child0_child1$child2._get('loginButton_top'),'openST'])
//assigning radius to (${parent.height} / 1.8)
			_this_child0_child0_child1$child2._replaceUpdater('radius', function() { _this_child0_child0_child1$child2.radius = (_this_child0_child0_child1$child2.parent.height / 1.8) }, [_this_child0_child0_child1$child2.parent,'height'])
//assigning color to (${topPanel.color})
			_this_child0_child0_child1$child2._replaceUpdater('color', function() { _this_child0_child0_child1$child2.color = (_this_child0_child0_child1$child2._get('topPanel').color) }, [_this_child0_child0_child1$child2._get('topPanel'),'color'])
//assigning enabled to (${topPanel.visible})
			_this_child0_child0_child1$child2._replaceUpdater('enabled', function() { _this_child0_child0_child1$child2.enabled = (_this_child0_child0_child1$child2._get('topPanel').visible) }, [_this_child0_child0_child1$child2._get('topPanel'),'visible'])
			_this_child0_child0_child1$child2.on('clicked', function() {
	var templatePage = this._get('templatePage', true)
                        ...
                        //                        menuSpace.isQuestionSearch = false
                        //                        menuSpace.isSendingMesage = false
                        //                        menuSpace.isLogin = true

                        menuSpace.menuMode = "isLogin"

                        templatePage.searchSignal()
                    }.bind(_this_child0_child0_child1$child2))

			_this_child0_child0_child1$child2.completed()

//setting up component URoundButton
			var _this_child0_child0_child1$child3 = $c._this_child0_child0_child1$child3
			_this_child0_child0_child1$child3.$s($c.$c$_this_child0_child0_child1$child3)
			delete $c.$c$_this_child0_child0_child1$child3

//assigning anchors.verticalCenter to (${parent.verticalCenter})
			_this_child0_child0_child1$child3.anchors._replaceUpdater('verticalCenter', function() { _this_child0_child0_child1$child3.anchors.verticalCenter = (_this_child0_child0_child1$child3.parent.verticalCenter) }, [_this_child0_child0_child1$child3.parent,'verticalCenter'])
//assigning anchors.right to (${searchButton_top.left})
			_this_child0_child0_child1$child3.anchors._replaceUpdater('right', function() { _this_child0_child0_child1$child3.anchors.right = (_this_child0_child0_child1$child3._get('searchButton_top').left) }, [_this_child0_child0_child1$child3._get('searchButton_top'),'left'])
//assigning anchors.rightMargin to ((${parent.width} - 2 * (1 + 0.5) * ${menuButton_top.width} - 2 * ${menuButton_top.anchors.leftMargin}) / 3 - ${width} / 3)
			_this_child0_child0_child1$child3.anchors._replaceUpdater('rightMargin', function() { _this_child0_child0_child1$child3.anchors.rightMargin = ((_this_child0_child0_child1$child3.parent.width - 2 * (1 + 0.5) * _this_child0_child0_child1$child3._get('menuButton_top').width - 2 * _this_child0_child0_child1$child3._get('menuButton_top').anchors.leftMargin) / 3 - _this_child0_child0_child1$child3.width / 3) }, [_this_child0_child0_child1$child3.parent,'width',_this_child0_child0_child1$child3._get('menuButton_top'),'width',_this_child0_child0_child1$child3._get('menuButton_top').anchors,'leftMargin',_this_child0_child0_child1$child3,'width'])
//assigning imageSource to (! ${emailButton_top.openST} ? "Icons/messengers.svg" : "Icons/whiteCross2.svg")
			_this_child0_child0_child1$child3._replaceUpdater('imageSource', function() { _this_child0_child0_child1$child3.imageSource = (! _this_child0_child0_child1$child3._get('emailButton_top').openST ? "Icons/messengers.svg" : "Icons/whiteCross2.svg") }, [_this_child0_child0_child1$child3._get('emailButton_top'),'openST'])
//assigning radius to (${parent.height} / 1.8)
			_this_child0_child0_child1$child3._replaceUpdater('radius', function() { _this_child0_child0_child1$child3.radius = (_this_child0_child0_child1$child3.parent.height / 1.8) }, [_this_child0_child0_child1$child3.parent,'height'])
//assigning color to (${topPanel.color})
			_this_child0_child0_child1$child3._replaceUpdater('color', function() { _this_child0_child0_child1$child3.color = (_this_child0_child0_child1$child3._get('topPanel').color) }, [_this_child0_child0_child1$child3._get('topPanel'),'color'])
//assigning enabled to (${topPanel.visible})
			_this_child0_child0_child1$child3._replaceUpdater('enabled', function() { _this_child0_child0_child1$child3.enabled = (_this_child0_child0_child1$child3._get('topPanel').visible) }, [_this_child0_child0_child1$child3._get('topPanel'),'visible'])
			_this_child0_child0_child1$child3.on('clicked', function() {
	var templatePage = this._get('templatePage', true)
                        ...
                        //                        menuSpace.isMenuList = false
                        //                        menuSpace.isQuestionSearch = false
                        //                        menuSpace.isSendingMesage = true
                        //                        menuSpace.isLogin = false

                        menuSpace.menuMode = "isSendingMesage"

                        templatePage.searchSignal()
                    }.bind(_this_child0_child0_child1$child3))

			_this_child0_child0_child1$child3.completed()

			_this_child0_child0$child1.completed()

//setting up component Rectangle
			var _this_child0_child0$child2 = $c._this_child0_child0$child2
			_this_child0_child0$child2.$s($c.$c$_this_child0_child0$child2)
			delete $c.$c$_this_child0_child0$child2

//assigning anchors.top to (${parent.top})
			_this_child0_child0$child2.anchors._replaceUpdater('top', function() { _this_child0_child0$child2.anchors.top = (_this_child0_child0$child2.parent.top) }, [_this_child0_child0$child2.parent,'top'])
//assigning anchors.bottom to (${parent.bottom})
			_this_child0_child0$child2.anchors._replaceUpdater('bottom', function() { _this_child0_child0$child2.anchors.bottom = (_this_child0_child0$child2.parent.bottom) }, [_this_child0_child0$child2.parent,'bottom'])
//assigning anchors.left to (${parent.left})
			_this_child0_child0$child2.anchors._replaceUpdater('left', function() { _this_child0_child0$child2.anchors.left = (_this_child0_child0$child2.parent.left) }, [_this_child0_child0$child2.parent,'left'])
//assigning width to (${visible} ? 60 : 0)
			_this_child0_child0$child2._replaceUpdater('width', function() { _this_child0_child0$child2.width = (_this_child0_child0$child2.visible ? 60 : 0) }, [_this_child0_child0$child2,'visible'])
//assigning color to ("#055A85")
			_this_child0_child0$child2._removeUpdater('color'); _this_child0_child0$child2.color = ("#055A85");
//assigning visible to (! ${templatePage.mobile})
			_this_child0_child0$child2._replaceUpdater('visible', function() { _this_child0_child0$child2.visible = (! _this_child0_child0$child2._get('templatePage').mobile) }, [_this_child0_child0$child2._get('templatePage'),'mobile'])

//setting up component MouseArea
			var _this_child0_child0_child2$child0 = $c._this_child0_child0_child2$child0
			_this_child0_child0_child2$child0.$s($c.$c$_this_child0_child0_child2$child0)
			delete $c.$c$_this_child0_child0_child2$child0

//assigning anchors.fill to (${parent})
			_this_child0_child0_child2$child0.anchors._removeUpdater('fill'); _this_child0_child0_child2$child0.anchors.fill = (_this_child0_child0_child2$child0.parent);

			_this_child0_child0_child2$child0.completed()

//setting up component URoundButton
			var _this_child0_child0_child2$child1 = $c._this_child0_child0_child2$child1
			_this_child0_child0_child2$child1.$s($c.$c$_this_child0_child0_child2$child1)
			delete $c.$c$_this_child0_child0_child2$child1

//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child2$child1.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child2$child1.anchors.horizontalCenter = (_this_child0_child0_child2$child1.parent.horizontalCenter) }, [_this_child0_child0_child2$child1.parent,'horizontalCenter'])
//assigning anchors.top to (${parent.top})
			_this_child0_child0_child2$child1.anchors._replaceUpdater('top', function() { _this_child0_child0_child2$child1.anchors.top = (_this_child0_child0_child2$child1.parent.top) }, [_this_child0_child0_child2$child1.parent,'top'])
//assigning anchors.topMargin to (10)
			_this_child0_child0_child2$child1.anchors._removeUpdater('topMargin'); _this_child0_child0_child2$child1.anchors.topMargin = (10);
//assigning imageSource to (! ${menuButton.openST} ? "Icons/menu.svg" : "Icons/whiteCross2.svg")
			_this_child0_child0_child2$child1._replaceUpdater('imageSource', function() { _this_child0_child0_child2$child1.imageSource = (! _this_child0_child0_child2$child1._get('menuButton').openST ? "Icons/menu.svg" : "Icons/whiteCross2.svg") }, [_this_child0_child0_child2$child1._get('menuButton'),'openST'])
//assigning radius to (${parent.width} / 1.8)
			_this_child0_child0_child2$child1._replaceUpdater('radius', function() { _this_child0_child0_child2$child1.radius = (_this_child0_child0_child2$child1.parent.width / 1.8) }, [_this_child0_child0_child2$child1.parent,'width'])
//assigning color to (${leftPanel.color})
			_this_child0_child0_child2$child1._replaceUpdater('color', function() { _this_child0_child0_child2$child1.color = (_this_child0_child0_child2$child1._get('leftPanel').color) }, [_this_child0_child0_child2$child1._get('leftPanel'),'color'])
//assigning enabled to (${leftPanel.visible})
			_this_child0_child0_child2$child1._replaceUpdater('enabled', function() { _this_child0_child0_child2$child1.enabled = (_this_child0_child0_child2$child1._get('leftPanel').visible) }, [_this_child0_child0_child2$child1._get('leftPanel'),'visible'])
			_this_child0_child0_child2$child1.on('clicked', function() {
	var menuButton = this._get('menuButton', true), templatePage = this._get('templatePage', true)

                        if(!menuSpace.openST)
                            menuSpace.openST = true
                        else if (openST)
                            menuSpace.openST = false
                        //                    menuButton.openST = !menuButton.openST
                        ...
                        //templatePage.menufunction()
                        templatePage.menuSignal()
                    }.bind(_this_child0_child0_child2$child1))

			_this_child0_child0_child2$child1.completed()

//setting up component URoundButton
			var _this_child0_child0_child2$child2 = $c._this_child0_child0_child2$child2
			_this_child0_child0_child2$child2.$s($c.$c$_this_child0_child0_child2$child2)
			delete $c.$c$_this_child0_child0_child2$child2

//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child2$child2.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child2$child2.anchors.horizontalCenter = (_this_child0_child0_child2$child2.parent.horizontalCenter) }, [_this_child0_child0_child2$child2.parent,'horizontalCenter'])
//assigning anchors.top to (${menuButton.bottom})
			_this_child0_child0_child2$child2.anchors._replaceUpdater('top', function() { _this_child0_child0_child2$child2.anchors.top = (_this_child0_child0_child2$child2._get('menuButton').bottom) }, [_this_child0_child0_child2$child2._get('menuButton'),'bottom'])
//assigning anchors.topMargin to (10)
			_this_child0_child0_child2$child2.anchors._removeUpdater('topMargin'); _this_child0_child0_child2$child2.anchors.topMargin = (10);
//assigning imageSource to (! ${searchButton.openST} ? "Icons/search.svg" : "Icons/whiteCross2.svg")
			_this_child0_child0_child2$child2._replaceUpdater('imageSource', function() { _this_child0_child0_child2$child2.imageSource = (! _this_child0_child0_child2$child2._get('searchButton').openST ? "Icons/search.svg" : "Icons/whiteCross2.svg") }, [_this_child0_child0_child2$child2._get('searchButton'),'openST'])
//assigning radius to (${parent.width} / 1.8)
			_this_child0_child0_child2$child2._replaceUpdater('radius', function() { _this_child0_child0_child2$child2.radius = (_this_child0_child0_child2$child2.parent.width / 1.8) }, [_this_child0_child0_child2$child2.parent,'width'])
//assigning color to (${leftPanel.color})
			_this_child0_child0_child2$child2._replaceUpdater('color', function() { _this_child0_child0_child2$child2.color = (_this_child0_child0_child2$child2._get('leftPanel').color) }, [_this_child0_child0_child2$child2._get('leftPanel'),'color'])
//assigning enabled to (${leftPanel.visible})
			_this_child0_child0_child2$child2._replaceUpdater('enabled', function() { _this_child0_child0_child2$child2.enabled = (_this_child0_child0_child2$child2._get('leftPanel').visible) }, [_this_child0_child0_child2$child2._get('leftPanel'),'visible'])
			_this_child0_child0_child2$child2.on('clicked', function() {
	var searchButton = this._get('searchButton', true), templatePage = this._get('templatePage', true)

                        if(!menuSpace.openST)
                            menuSpace.openST = true
                        else if (openST)
                            menuSpace.openST = false
                        //searchButton.openST = !searchButton.openST
                        ...
                        templatePage.searchSignal()
                    }.bind(_this_child0_child0_child2$child2))

			_this_child0_child0_child2$child2.completed()

//setting up component Column
			var _this_child0_child0_child2$child3 = $c._this_child0_child0_child2$child3
			_this_child0_child0_child2$child3.$s($c.$c$_this_child0_child0_child2$child3)
			delete $c.$c$_this_child0_child0_child2$child3

//assigning width to (${parent.width})
			_this_child0_child0_child2$child3._replaceUpdater('width', function() { _this_child0_child0_child2$child3.width = (_this_child0_child0_child2$child3.parent.width) }, [_this_child0_child0_child2$child3.parent,'width'])
//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child2$child3.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child2$child3.anchors.horizontalCenter = (_this_child0_child0_child2$child3.parent.horizontalCenter) }, [_this_child0_child0_child2$child3.parent,'horizontalCenter'])
//assigning anchors.top to (${searchButton.bottom})
			_this_child0_child0_child2$child3.anchors._replaceUpdater('top', function() { _this_child0_child0_child2$child3.anchors.top = (_this_child0_child0_child2$child3._get('searchButton').bottom) }, [_this_child0_child0_child2$child3._get('searchButton'),'bottom'])
//assigning anchors.topMargin to (80)
			_this_child0_child0_child2$child3.anchors._removeUpdater('topMargin'); _this_child0_child0_child2$child3.anchors.topMargin = (80);
//assigning spacing to (10)
			_this_child0_child0_child2$child3._removeUpdater('spacing'); _this_child0_child0_child2$child3.spacing = (10);

//setting up component URoundButton
			var _this_child0_child0_child2_child3$child0 = $c._this_child0_child0_child2_child3$child0
			_this_child0_child0_child2_child3$child0.$s($c.$c$_this_child0_child0_child2_child3$child0)
			delete $c.$c$_this_child0_child0_child2_child3$child0

//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child2_child3$child0.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child2_child3$child0.anchors.horizontalCenter = (_this_child0_child0_child2_child3$child0.parent.horizontalCenter) }, [_this_child0_child0_child2_child3$child0.parent,'horizontalCenter'])
//assigning imageSource to ("Icons/vk.svg")
			_this_child0_child0_child2_child3$child0._removeUpdater('imageSource'); _this_child0_child0_child2_child3$child0.imageSource = ("Icons/vk.svg");
//assigning radius to (${parent.width} / 1.5)
			_this_child0_child0_child2_child3$child0._replaceUpdater('radius', function() { _this_child0_child0_child2_child3$child0.radius = (_this_child0_child0_child2_child3$child0.parent.width / 1.5) }, [_this_child0_child0_child2_child3$child0.parent,'width'])
//assigning color to ("transparent")
			_this_child0_child0_child2_child3$child0._removeUpdater('color'); _this_child0_child0_child2_child3$child0.color = ("transparent");
//assigning imageDecrease to (1)
			_this_child0_child0_child2_child3$child0._removeUpdater('imageDecrease'); _this_child0_child0_child2_child3$child0.imageDecrease = (1);
//assigning enabled to (${leftPanel.visible})
			_this_child0_child0_child2_child3$child0._replaceUpdater('enabled', function() { _this_child0_child0_child2_child3$child0.enabled = (_this_child0_child0_child2_child3$child0._get('leftPanel').visible) }, [_this_child0_child0_child2_child3$child0._get('leftPanel'),'visible'])
			_this_child0_child0_child2_child3$child0.on('clicked', function() {
	var templatePage = this._get('templatePage', true)

                            //menuSpace.openST = !menuSpace.openST
                            templatePage.vkSignal()
                        }.bind(_this_child0_child0_child2_child3$child0))

			_this_child0_child0_child2_child3$child0.completed()

//setting up component URoundButton
			var _this_child0_child0_child2_child3$child1 = $c._this_child0_child0_child2_child3$child1
			_this_child0_child0_child2_child3$child1.$s($c.$c$_this_child0_child0_child2_child3$child1)
			delete $c.$c$_this_child0_child0_child2_child3$child1

//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child2_child3$child1.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child2_child3$child1.anchors.horizontalCenter = (_this_child0_child0_child2_child3$child1.parent.horizontalCenter) }, [_this_child0_child0_child2_child3$child1.parent,'horizontalCenter'])
//assigning imageSource to ("Icons/facebook.svg")
			_this_child0_child0_child2_child3$child1._removeUpdater('imageSource'); _this_child0_child0_child2_child3$child1.imageSource = ("Icons/facebook.svg");
//assigning radius to (${parent.width} / 1.5)
			_this_child0_child0_child2_child3$child1._replaceUpdater('radius', function() { _this_child0_child0_child2_child3$child1.radius = (_this_child0_child0_child2_child3$child1.parent.width / 1.5) }, [_this_child0_child0_child2_child3$child1.parent,'width'])
//assigning color to ("transparent")
			_this_child0_child0_child2_child3$child1._removeUpdater('color'); _this_child0_child0_child2_child3$child1.color = ("transparent");
//assigning imageDecrease to (1)
			_this_child0_child0_child2_child3$child1._removeUpdater('imageDecrease'); _this_child0_child0_child2_child3$child1.imageDecrease = (1);
//assigning enabled to (${leftPanel.visible})
			_this_child0_child0_child2_child3$child1._replaceUpdater('enabled', function() { _this_child0_child0_child2_child3$child1.enabled = (_this_child0_child0_child2_child3$child1._get('leftPanel').visible) }, [_this_child0_child0_child2_child3$child1._get('leftPanel'),'visible'])
			_this_child0_child0_child2_child3$child1.on('clicked', function() {
	var templatePage = this._get('templatePage', true)

                            //menuSpace.openST = !menuSpace.openST
                            templatePage.vkSignal()
                        }.bind(_this_child0_child0_child2_child3$child1))

			_this_child0_child0_child2_child3$child1.completed()

//setting up component URoundButton
			var _this_child0_child0_child2_child3$child2 = $c._this_child0_child0_child2_child3$child2
			_this_child0_child0_child2_child3$child2.$s($c.$c$_this_child0_child0_child2_child3$child2)
			delete $c.$c$_this_child0_child0_child2_child3$child2

//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child2_child3$child2.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child2_child3$child2.anchors.horizontalCenter = (_this_child0_child0_child2_child3$child2.parent.horizontalCenter) }, [_this_child0_child0_child2_child3$child2.parent,'horizontalCenter'])
//assigning imageSource to ("Icons/phone.svg")
			_this_child0_child0_child2_child3$child2._removeUpdater('imageSource'); _this_child0_child0_child2_child3$child2.imageSource = ("Icons/phone.svg");
//assigning radius to (${parent.width} / 1.5)
			_this_child0_child0_child2_child3$child2._replaceUpdater('radius', function() { _this_child0_child0_child2_child3$child2.radius = (_this_child0_child0_child2_child3$child2.parent.width / 1.5) }, [_this_child0_child0_child2_child3$child2.parent,'width'])
//assigning color to ("transparent")
			_this_child0_child0_child2_child3$child2._removeUpdater('color'); _this_child0_child0_child2_child3$child2.color = ("transparent");
//assigning imageDecrease to (1)
			_this_child0_child0_child2_child3$child2._removeUpdater('imageDecrease'); _this_child0_child0_child2_child3$child2.imageDecrease = (1);
//assigning enabled to (${leftPanel.visible})
			_this_child0_child0_child2_child3$child2._replaceUpdater('enabled', function() { _this_child0_child0_child2_child3$child2.enabled = (_this_child0_child0_child2_child3$child2._get('leftPanel').visible) }, [_this_child0_child0_child2_child3$child2._get('leftPanel'),'visible'])
			_this_child0_child0_child2_child3$child2.on('clicked', function() {
	var templatePage = this._get('templatePage', true)

                            //menuSpace.openST = !menuSpace.openST
                            templatePage.viberSignal()
                        }.bind(_this_child0_child0_child2_child3$child2))

			_this_child0_child0_child2_child3$child2.completed()

//setting up component URoundButton
			var _this_child0_child0_child2_child3$child3 = $c._this_child0_child0_child2_child3$child3
			_this_child0_child0_child2_child3$child3.$s($c.$c$_this_child0_child0_child2_child3$child3)
			delete $c.$c$_this_child0_child0_child2_child3$child3

//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0_child0_child2_child3$child3.anchors._replaceUpdater('horizontalCenter', function() { _this_child0_child0_child2_child3$child3.anchors.horizontalCenter = (_this_child0_child0_child2_child3$child3.parent.horizontalCenter) }, [_this_child0_child0_child2_child3$child3.parent,'horizontalCenter'])
//assigning imageSource to (${openST} ? "Icons/mail_white.svg" : "Icons/mail.svg")
			_this_child0_child0_child2_child3$child3._replaceUpdater('imageSource', function() { _this_child0_child0_child2_child3$child3.imageSource = (_this_child0_child0_child2_child3$child3.openST ? "Icons/mail_white.svg" : "Icons/mail.svg") }, [_this_child0_child0_child2_child3$child3,'openST'])
//assigning radius to (${parent.width} / 1.5)
			_this_child0_child0_child2_child3$child3._replaceUpdater('radius', function() { _this_child0_child0_child2_child3$child3.radius = (_this_child0_child0_child2_child3$child3.parent.width / 1.5) }, [_this_child0_child0_child2_child3$child3.parent,'width'])
//assigning color to ("transparent")
			_this_child0_child0_child2_child3$child3._removeUpdater('color'); _this_child0_child0_child2_child3$child3.color = ("transparent");
//assigning enabled to (${leftPanel.visible})
			_this_child0_child0_child2_child3$child3._replaceUpdater('enabled', function() { _this_child0_child0_child2_child3$child3.enabled = (_this_child0_child0_child2_child3$child3._get('leftPanel').visible) }, [_this_child0_child0_child2_child3$child3._get('leftPanel'),'visible'])
			_this_child0_child0_child2_child3$child3.on('clicked', function() {
	var templatePage = this._get('templatePage', true)
                            ...
                            templatePage.emailSignal()
                        }.bind(_this_child0_child0_child2_child3$child3))

			_this_child0_child0_child2_child3$child3.completed()

			_this_child0_child0_child2$child3.completed()

			_this_child0_child0$child2.completed()

//setting up component Rectangle
			var _this_child0_child0$child3 = $c._this_child0_child0$child3
			_this_child0_child0$child3.$s($c.$c$_this_child0_child0$child3)
			delete $c.$c$_this_child0_child0$child3

//assigning anchors.bottom to (${parent.bottom})
			_this_child0_child0$child3.anchors._replaceUpdater('bottom', function() { _this_child0_child0$child3.anchors.bottom = (_this_child0_child0$child3.parent.bottom) }, [_this_child0_child0$child3.parent,'bottom'])
//assigning anchors.left to (${leftPanel.right})
			_this_child0_child0$child3.anchors._replaceUpdater('left', function() { _this_child0_child0$child3.anchors.left = (_this_child0_child0$child3._get('leftPanel').right) }, [_this_child0_child0$child3._get('leftPanel'),'right'])
//assigning anchors.leftMargin to (${templatePage.mobile} ? 0 : ${header.anchors.leftMargin})
			_this_child0_child0$child3.anchors._replaceUpdater('leftMargin', function() { _this_child0_child0$child3.anchors.leftMargin = (_this_child0_child0$child3._get('templatePage').mobile ? 0 : _this_child0_child0$child3._get('header').anchors.leftMargin) }, [_this_child0_child0$child3._get('templatePage'),'mobile',_this_child0_child0$child3._get('header').anchors,'leftMargin'])
//assigning width to (${templatePage.mobile} ? ${templatePage.width} - ${leftPanel.width} : ${header.width})
			_this_child0_child0$child3._replaceUpdater('width', function() { _this_child0_child0$child3.width = (_this_child0_child0$child3._get('templatePage').mobile ? _this_child0_child0$child3._get('templatePage').width - _this_child0_child0$child3._get('leftPanel').width : _this_child0_child0$child3._get('header').width) }, [_this_child0_child0$child3._get('templatePage'),'mobile',_this_child0_child0$child3._get('templatePage'),'width',_this_child0_child0$child3._get('leftPanel'),'width',_this_child0_child0$child3._get('header'),'width'])
//assigning height to (! ${templatePage.mobile} ? ${desktopHeight} : ${footerTextContainer.y} + ${footerTextContainer.height} + 2 * ${footer.margin})
			_this_child0_child0$child3._replaceUpdater('height', function() { _this_child0_child0$child3.height = (! _this_child0_child0$child3._get('templatePage').mobile ? _this_child0_child0$child3.desktopHeight : _this_child0_child0$child3._get('footerTextContainer').y + _this_child0_child0$child3._get('footerTextContainer').height + 2 * _this_child0_child0$child3._get('footer').margin) }, [_this_child0_child0$child3._get('templatePage'),'mobile',_this_child0_child0$child3,'desktopHeight',_this_child0_child0$child3._get('footerTextContainer'),'y',_this_child0_child0$child3._get('footerTextContainer'),'height',_this_child0_child0$child3._get('footer'),'margin'])
//assigning color to (${templatePage.mobile} ? ${templatePage.mainColor} : "white")
			_this_child0_child0$child3._replaceUpdater('color', function() { _this_child0_child0$child3.color = (_this_child0_child0$child3._get('templatePage').mobile ? _this_child0_child0$child3._get('templatePage').mainColor : "white") }, [_this_child0_child0$child3._get('templatePage'),'mobile',_this_child0_child0$child3._get('templatePage'),'mainColor'])

//setting up component Rectangle
			var _this_child0_child0_child3$child0 = $c._this_child0_child0_child3$child0
			_this_child0_child0_child3$child0.$s($c.$c$_this_child0_child0_child3$child0)
			delete $c.$c$_this_child0_child0_child3$child0

//assigning y to (${templatePage.mobile} ? ${footer.margin} : ${parent.height} / 2 - ${height} / 2)
			_this_child0_child0_child3$child0._replaceUpdater('y', function() { _this_child0_child0_child3$child0.y = (_this_child0_child0_child3$child0._get('templatePage').mobile ? _this_child0_child0_child3$child0._get('footer').margin : _this_child0_child0_child3$child0.parent.height / 2 - _this_child0_child0_child3$child0.height / 2) }, [_this_child0_child0_child3$child0._get('templatePage'),'mobile',_this_child0_child0_child3$child0._get('footer'),'margin',_this_child0_child0_child3$child0.parent,'height',_this_child0_child0_child3$child0,'height'])
//assigning x to (${templatePage.mobile} ? ${footer.margin} : 0)
			_this_child0_child0_child3$child0._replaceUpdater('x', function() { _this_child0_child0_child3$child0.x = (_this_child0_child0_child3$child0._get('templatePage').mobile ? _this_child0_child0_child3$child0._get('footer').margin : 0) }, [_this_child0_child0_child3$child0._get('templatePage'),'mobile',_this_child0_child0_child3$child0._get('footer'),'margin'])
//assigning width to (${templatePage.mobile} && ${parent.width} > 300 ? Math.min((250),(${parent.width} / 2)) : ${templatePage.mobile} && ${parent.width} <= 300 ? Math.min((250),(${parent.width} / 3 * 2)) : 250)
			_this_child0_child0_child3$child0._replaceUpdater('width', function() { _this_child0_child0_child3$child0.width = (_this_child0_child0_child3$child0._get('templatePage').mobile && _this_child0_child0_child3$child0.parent.width > 300 ? Math.min((250),(_this_child0_child0_child3$child0.parent.width / 2)) : _this_child0_child0_child3$child0._get('templatePage').mobile && _this_child0_child0_child3$child0.parent.width <= 300 ? Math.min((250),(_this_child0_child0_child3$child0.parent.width / 3 * 2)) : 250) }, [_this_child0_child0_child3$child0._get('templatePage'),'mobile',_this_child0_child0_child3$child0.parent,'width'])
//assigning height to (${templatePage.mobile} ? ${width} / 250 * 80 : 80)
			_this_child0_child0_child3$child0._replaceUpdater('height', function() { _this_child0_child0_child3$child0.height = (_this_child0_child0_child3$child0._get('templatePage').mobile ? _this_child0_child0_child3$child0.width / 250 * 80 : 80) }, [_this_child0_child0_child3$child0._get('templatePage'),'mobile',_this_child0_child0_child3$child0,'width'])
//assigning color to ("transparent")
			_this_child0_child0_child3$child0._removeUpdater('color'); _this_child0_child0_child3$child0.color = ("transparent");

//setting up component Image
			var _this_child0_child0_child3_child0$child0 = $c._this_child0_child0_child3_child0$child0
			_this_child0_child0_child3_child0$child0.$s($c.$c$_this_child0_child0_child3_child0$child0)
			delete $c.$c$_this_child0_child0_child3_child0$child0

//assigning width to (${parent.width})
			_this_child0_child0_child3_child0$child0._replaceUpdater('width', function() { _this_child0_child0_child3_child0$child0.width = (_this_child0_child0_child3_child0$child0.parent.width) }, [_this_child0_child0_child3_child0$child0.parent,'width'])
//assigning height to (${parent.height})
			_this_child0_child0_child3_child0$child0._replaceUpdater('height', function() { _this_child0_child0_child3_child0$child0.height = (_this_child0_child0_child3_child0$child0.parent.height) }, [_this_child0_child0_child3_child0$child0.parent,'height'])
//assigning source to (${templatePage.mobile} ? "Images/mainLogo_white.svg" : "Images/mainLogo.svg")
			_this_child0_child0_child3_child0$child0._replaceUpdater('source', function() { _this_child0_child0_child3_child0$child0.source = (_this_child0_child0_child3_child0$child0._get('templatePage').mobile ? "Images/mainLogo_white.svg" : "Images/mainLogo.svg") }, [_this_child0_child0_child3_child0$child0._get('templatePage'),'mobile'])

			_this_child0_child0_child3_child0$child0.completed()

//setting up component MouseArea
			var _this_child0_child0_child3_child0$child1 = $c._this_child0_child0_child3_child0$child1
			_this_child0_child0_child3_child0$child1.$s($c.$c$_this_child0_child0_child3_child0$child1)
			delete $c.$c$_this_child0_child0_child3_child0$child1

//assigning anchors.fill to (${parent})
			_this_child0_child0_child3_child0$child1.anchors._removeUpdater('fill'); _this_child0_child0_child3_child0$child1.anchors.fill = (_this_child0_child0_child3_child0$child1.parent);
//assigning enabled to (true)
			_this_child0_child0_child3_child0$child1._removeUpdater('enabled'); _this_child0_child0_child3_child0$child1.enabled = (true);
//assigning hoverEnabled to (${enabled})
			_this_child0_child0_child3_child0$child1._replaceUpdater('hoverEnabled', function() { _this_child0_child0_child3_child0$child1.hoverEnabled = (_this_child0_child0_child3_child0$child1.enabled) }, [_this_child0_child0_child3_child0$child1,'enabled'])
//assigning cursorShape to (${containsMouse} ? "pointer" : "default")
			_this_child0_child0_child3_child0$child1._replaceUpdater('cursorShape', function() { _this_child0_child0_child3_child0$child1.cursorShape = (_this_child0_child0_child3_child0$child1.containsMouse ? "pointer" : "default") }, [_this_child0_child0_child3_child0$child1,'containsMouse'])
			_this_child0_child0_child3_child0$child1.on('clicked', function() {
	var window = this._get('window', true)

                            changeSourceItem(window.homeURL);
                        }.bind(_this_child0_child0_child3_child0$child1))

			_this_child0_child0_child3_child0$child1.completed()

			_this_child0_child0_child3$child0.completed()

//setting up component Rectangle
			var _this_child0_child0_child3$child1 = $c._this_child0_child0_child3$child1
			_this_child0_child0_child3$child1.$s($c.$c$_this_child0_child0_child3$child1)
			delete $c.$c$_this_child0_child0_child3$child1

//assigning x to (${templatePage.mobile} ? ${footer.margin} : ${parent.width} - ${width})
			_this_child0_child0_child3$child1._replaceUpdater('x', function() { _this_child0_child0_child3$child1.x = (_this_child0_child0_child3$child1._get('templatePage').mobile ? _this_child0_child0_child3$child1._get('footer').margin : _this_child0_child0_child3$child1.parent.width - _this_child0_child0_child3$child1.width) }, [_this_child0_child0_child3$child1._get('templatePage'),'mobile',_this_child0_child0_child3$child1._get('footer'),'margin',_this_child0_child0_child3$child1.parent,'width',_this_child0_child0_child3$child1,'width'])
//assigning y to (${templatePage.mobile} ? (${logoContainerFooter.height} + 20) : ${footer.desktopHeight} / 2 - ${height} / 2)
			_this_child0_child0_child3$child1._replaceUpdater('y', function() { _this_child0_child0_child3$child1.y = (_this_child0_child0_child3$child1._get('templatePage').mobile ? (_this_child0_child0_child3$child1._get('logoContainerFooter').height + 20) : _this_child0_child0_child3$child1._get('footer').desktopHeight / 2 - _this_child0_child0_child3$child1.height / 2) }, [_this_child0_child0_child3$child1._get('templatePage'),'mobile',_this_child0_child0_child3$child1._get('logoContainerFooter'),'height',_this_child0_child0_child3$child1._get('footer'),'desktopHeight',_this_child0_child0_child3$child1,'height'])
//assigning height to (40)
			_this_child0_child0_child3$child1._removeUpdater('height'); _this_child0_child0_child3$child1.height = (40);
//assigning width to (250)
			_this_child0_child0_child3$child1._removeUpdater('width'); _this_child0_child0_child3$child1.width = (250);
//assigning color to (${templatePage.mobile} ? "transparent" : "white")
			_this_child0_child0_child3$child1._replaceUpdater('color', function() { _this_child0_child0_child3$child1.color = (_this_child0_child0_child3$child1._get('templatePage').mobile ? "transparent" : "white") }, [_this_child0_child0_child3$child1._get('templatePage'),'mobile'])
//assigning fontSize to (${templatePage.mobile} ? 16 : 18)
			_this_child0_child0_child3$child1._replaceUpdater('fontSize', function() { _this_child0_child0_child3$child1.fontSize = (_this_child0_child0_child3$child1._get('templatePage').mobile ? 16 : 18) }, [_this_child0_child0_child3$child1._get('templatePage'),'mobile'])

//setting up component Text
			var _this_child0_child0_child3_child1$child0 = $c._this_child0_child0_child3_child1$child0
			_this_child0_child0_child3_child1$child0.$s($c.$c$_this_child0_child0_child3_child1$child0)
			delete $c.$c$_this_child0_child0_child3_child1$child0

//assigning anchors.top to (${parent.top})
			_this_child0_child0_child3_child1$child0.anchors._replaceUpdater('top', function() { _this_child0_child0_child3_child1$child0.anchors.top = (_this_child0_child0_child3_child1$child0.parent.top) }, [_this_child0_child0_child3_child1$child0.parent,'top'])
//assigning anchors.left to (${parent.left})
			_this_child0_child0_child3_child1$child0.anchors._replaceUpdater('left', function() { _this_child0_child0_child3_child1$child0.anchors.left = (_this_child0_child0_child3_child1$child0.parent.left) }, [_this_child0_child0_child3_child1$child0.parent,'left'])
//assigning font.pixelSize to (${footerTextContainer.fontSize})
			_this_child0_child0_child3_child1$child0.font._replaceUpdater('pixelSize', function() { _this_child0_child0_child3_child1$child0.font.pixelSize = (_this_child0_child0_child3_child1$child0._get('footerTextContainer').fontSize) }, [_this_child0_child0_child3_child1$child0._get('footerTextContainer'),'fontSize'])
//assigning font.family to (${templatePage.fontFamily})
			_this_child0_child0_child3_child1$child0.font._replaceUpdater('family', function() { _this_child0_child0_child3_child1$child0.font.family = (_this_child0_child0_child3_child1$child0._get('templatePage').fontFamily) }, [_this_child0_child0_child3_child1$child0._get('templatePage'),'fontFamily'])
//assigning color to (${templatePage.mobile} ? "white" : ${templatePage.mainColor})
			_this_child0_child0_child3_child1$child0._replaceUpdater('color', function() { _this_child0_child0_child3_child1$child0.color = (_this_child0_child0_child3_child1$child0._get('templatePage').mobile ? "white" : _this_child0_child0_child3_child1$child0._get('templatePage').mainColor) }, [_this_child0_child0_child3_child1$child0._get('templatePage'),'mobile',_this_child0_child0_child3_child1$child0._get('templatePage'),'mainColor'])
//assigning wrapMode to (${templatePage.mobile} ? _globals.core.Text.prototype.WordWrap : _globals.core.Text.prototype.NoWrap)
			_this_child0_child0_child3_child1$child0._replaceUpdater('wrapMode', function() { _this_child0_child0_child3_child1$child0.wrapMode = (_this_child0_child0_child3_child1$child0._get('templatePage').mobile ? _globals.core.Text.prototype.WordWrap : _globals.core.Text.prototype.NoWrap) }, [_this_child0_child0_child3_child1$child0._get('templatePage'),'mobile'])
//assigning text to ("© 2005–2021 АО «Омск РТС»")
			_this_child0_child0_child3_child1$child0._removeUpdater('text'); _this_child0_child0_child3_child1$child0.text = ("© 2005–2021 АО «Омск РТС»");

			_this_child0_child0_child3_child1$child0.completed()

//setting up component Text
			var _this_child0_child0_child3_child1$child1 = $c._this_child0_child0_child3_child1$child1
			_this_child0_child0_child3_child1$child1.$s($c.$c$_this_child0_child0_child3_child1$child1)
			delete $c.$c$_this_child0_child0_child3_child1$child1

//assigning anchors.top to (${parent.top})
			_this_child0_child0_child3_child1$child1.anchors._replaceUpdater('top', function() { _this_child0_child0_child3_child1$child1.anchors.top = (_this_child0_child0_child3_child1$child1.parent.top) }, [_this_child0_child0_child3_child1$child1.parent,'top'])
//assigning anchors.topMargin to (28)
			_this_child0_child0_child3_child1$child1.anchors._removeUpdater('topMargin'); _this_child0_child0_child3_child1$child1.anchors.topMargin = (28);
//assigning anchors.left to (${parent.left})
			_this_child0_child0_child3_child1$child1.anchors._replaceUpdater('left', function() { _this_child0_child0_child3_child1$child1.anchors.left = (_this_child0_child0_child3_child1$child1.parent.left) }, [_this_child0_child0_child3_child1$child1.parent,'left'])
//assigning font.pixelSize to (${footerTextContainer.fontSize})
			_this_child0_child0_child3_child1$child1.font._replaceUpdater('pixelSize', function() { _this_child0_child0_child3_child1$child1.font.pixelSize = (_this_child0_child0_child3_child1$child1._get('footerTextContainer').fontSize) }, [_this_child0_child0_child3_child1$child1._get('footerTextContainer'),'fontSize'])
//assigning font.family to (${templatePage.fontFamily})
			_this_child0_child0_child3_child1$child1.font._replaceUpdater('family', function() { _this_child0_child0_child3_child1$child1.font.family = (_this_child0_child0_child3_child1$child1._get('templatePage').fontFamily) }, [_this_child0_child0_child3_child1$child1._get('templatePage'),'fontFamily'])
//assigning color to (${templatePage.mobile} ? "white" : ${templatePage.mainColor})
			_this_child0_child0_child3_child1$child1._replaceUpdater('color', function() { _this_child0_child0_child3_child1$child1.color = (_this_child0_child0_child3_child1$child1._get('templatePage').mobile ? "white" : _this_child0_child0_child3_child1$child1._get('templatePage').mainColor) }, [_this_child0_child0_child3_child1$child1._get('templatePage'),'mobile',_this_child0_child0_child3_child1$child1._get('templatePage'),'mainColor'])
//assigning wrapMode to (${templatePage.mobile} ? _globals.core.Text.prototype.WordWrap : _globals.core.Text.prototype.NoWrap)
			_this_child0_child0_child3_child1$child1._replaceUpdater('wrapMode', function() { _this_child0_child0_child3_child1$child1.wrapMode = (_this_child0_child0_child3_child1$child1._get('templatePage').mobile ? _globals.core.Text.prototype.WordWrap : _globals.core.Text.prototype.NoWrap) }, [_this_child0_child0_child3_child1$child1._get('templatePage'),'mobile'])
//assigning text to ("Политика конфиденциальности")
			_this_child0_child0_child3_child1$child1._removeUpdater('text'); _this_child0_child0_child3_child1$child1.text = ("Политика конфиденциальности");

			_this_child0_child0_child3_child1$child1.completed()

			_this_child0_child0_child3$child1.completed()

			_this_child0_child0$child3.completed()
...
//=====[component src.Pages.StartPage]=====================

	var StartPageBaseComponent = $src$Pages.TemplatePage
	var StartPageBasePrototype = StartPageBaseComponent.prototype

/**
 * @constructor
 * @extends {$src$Pages.TemplatePage}
 */
	var StartPageComponent = $src$Pages.StartPage = function(parent, row) {
		StartPageBaseComponent.apply(this, arguments)

	}
	var StartPagePrototype = StartPageComponent.prototype = Object.create(StartPageBasePrototype)

	StartPagePrototype.constructor = StartPageComponent

	StartPagePrototype.componentName = 'src.Pages.StartPage'

	StartPagePrototype.$c = function($c) {
		var $this = this;
		StartPageBasePrototype.$c.call(this, $c.$b = { })

	}
	StartPagePrototype.$s = function($c) {
		var $this = this;
	StartPageBasePrototype.$s.call(this, $c.$b); delete $c.$b
$this.completed()
}


//=====[component src.UxAdvancedComponents.UButton]=====================

	var UButtonBaseComponent = $core.Rectangle
	var UButtonBasePrototype = UButtonBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.Rectangle}
 */
	var UButtonComponent = $src$UxAdvancedComponents.UButton = function(parent, row) {
		UButtonBaseComponent.apply(this, arguments)

	}
	var UButtonPrototype = UButtonComponent.prototype = Object.create(UButtonBasePrototype)

	UButtonPrototype.constructor = UButtonComponent

	UButtonPrototype.componentName = 'src.UxAdvancedComponents.UButton'
	UButtonPrototype.clicked = $core.createSignal('clicked')
	core.addProperty(UButtonPrototype, 'string', 'text', ("Кнопка"))
	core.addProperty(UButtonPrototype, 'int', 'font', (16))
	core.addProperty(UButtonPrototype, 'bool', 'fontBold', (true))
	core.addProperty(UButtonPrototype, 'string', 'fontColor')
	core.addProperty(UButtonPrototype, 'string', 'fontFamily', (""))
	core.addProperty(UButtonPrototype, 'bool', 'shadow', (false))
	core.addProperty(UButtonPrototype, 'string', 'mainColor', ("#F18C16"))
	core.addProperty(UButtonPrototype, 'string', 'highlColor', ("#F18C16"))
	core.addProperty(UButtonPrototype, 'bool', 'scalable', (true))
	core.addProperty(UButtonPrototype, 'bool', 'enabled', (true))

	UButtonPrototype.$c = function($c) {
		var $this = this;
		UButtonBasePrototype.$c.call(this, $c.$b = { })
var _this$child0 = new $core.Rectangle($this)
		$c._this$child0 = _this$child0

//creating component Rectangle
		_this$child0.$c($c.$c$_this$child0 = { })
		var _this_child0$child0 = new $core.Text(_this$child0)
		$c._this_child0$child0 = _this_child0$child0

//creating component Text
		_this_child0$child0.$c($c.$c$_this_child0$child0 = { })
		_this_child0$child0._setId('tText')
		_this$child0.addChild(_this_child0$child0)
		_this$child0._setId('rect')
		$this.addChild(_this$child0)
...
//creating component MouseArea
		...
		$this._setId('button')
		core.addAliasProperty($this, 'textWidth', function() { return $this._get('tText') }, 'width')
		core.addAliasProperty($this, 'textHeight', function() { return $this._get('tText') }, 'height')
	}
	UButtonPrototype.$s = function($c) {
		var $this = this;
	UButtonBasePrototype.$s.call(this, $c.$b); delete $c.$b
//assigning fontColor to ('#fff')
			$this._removeUpdater('fontColor'); $this.fontColor = ('#fff');
//assigning width to (Math.max((300),(${tText.width})))
			$this._replaceUpdater('width', function() { $this.width = (Math.max((300),($this._get('tText').width))) }, [$this._get('tText'),'width'])
//assigning height to (Math.max((50),(${tText.height})))
			$this._replaceUpdater('height', function() { $this.height = (Math.max((50),($this._get('tText').height))) }, [$this._get('tText'),'height'])
//assigning radius to (${height})
			$this._replaceUpdater('radius', function() { $this.radius = ($this.height) }, [$this,'height'])
//assigning color to (! ${button.enabled} ? '#898989' : ${ma.containsMouse} ? ${button.highlColor} : ${button.mainColor})
			$this._replaceUpdater('color', function() { $this.color = (! $this._get('button').enabled ? '#898989' : $this._get('ma').containsMouse ? $this._get('button').highlColor : $this._get('button').mainColor) }, [$this._get('button'),'enabled',$this._get('ma'),'containsMouse',$this._get('button'),'highlColor',$this._get('button'),'mainColor'])
...
//assigning anchors.fill to (${parent})
			_this$child0.anchors._removeUpdater('fill'); _this$child0.anchors.fill = (_this$child0.parent);
//assigning color to (${button.color})
			_this$child0._replaceUpdater('color', function() { _this$child0.color = (_this$child0._get('button').color) }, [_this$child0._get('button'),'color'])
//assigning radius to (${button.radius})
			_this$child0._replaceUpdater('radius', function() { _this$child0.radius = (_this$child0._get('button').radius) }, [_this$child0._get('button'),'radius'])
...
//assigning text to (${button.text})
			_this_child0$child0._replaceUpdater('text', function() { _this_child0$child0.text = (_this_child0$child0._get('button').text) }, [_this_child0$child0._get('button'),'text'])
...
//assigning anchors.horizontalCenter to (${parent.horizontalCenter})
			_this_child0$child0.anchors._replaceUpdater('horizontalCenter', function() { _this_child0$child0.anchors.horizontalCenter = (_this_child0$child0.parent.horizontalCenter) }, [_this_child0$child0.parent,'horizontalCenter'])
//assigning color to (${button.fontColor})
			_this_child0$child0._replaceUpdater('color', function() { _this_child0$child0.color = (_this_child0$child0._get('button').fontColor) }, [_this_child0$child0._get('button'),'fontColor'])
//assigning font.family to (${button.fontFamily})
			_this_child0$child0.font._replaceUpdater('family', function() { _this_child0$child0.font.family = (_this_child0$child0._get('button').fontFamily) }, [_this_child0$child0._get('button'),'fontFamily'])
//assigning font.pixelSize to (${button.font})
			_this_child0$child0.font._replaceUpdater('pixelSize', function() { _this_child0$child0.font.pixelSize = (_this_child0$child0._get('button').font) }, [_this_child0$child0._get('button'),'font'])
//assigning font.bold to (${button.fontBold})
			_this_child0$child0.font._replaceUpdater('bold', function() { _this_child0$child0.font.bold = (_this_child0$child0._get('button').fontBold) }, [_this_child0$child0._get('button'),'fontBold'])
...
//assigning enabled to (true)
			_this$child1._removeUpdater('enabled'); _this$child1.enabled = (true);
//assigning hoverEnabled to (true)
			_this$child1._removeUpdater('hoverEnabled'); _this$child1.hoverEnabled = (true);
//assigning cursorShape to (! ${enabled} ? "default" : "pointer")
			_this$child1._replaceUpdater('cursorShape', function() { _this$child1.cursorShape = (! _this$child1.enabled ? "default" : "pointer") }, [_this$child1,'enabled'])
			_this$child1.on('clicked', function() {
	var button = this._get('button', true)
	...
	var button = this._get('button', true)
            ...
            if(scalable)
                button.transform.scale = !shadow ? 0.97 :1
            y+=shadow ? 4 :0
        }.bind(_this$child1))
	...
	var button = this._get('button', true)
            ...
            if(scalable)
                button.transform.scale = !shadow ? 1 : 1
            y -= shadow ? 4 : 0
...
//=====[component src.UxAdvancedComponents.URoundButton]=====================

	var URoundButtonBaseComponent = $core.Rectangle
	var URoundButtonBasePrototype = URoundButtonBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.Rectangle}
 */
	var URoundButtonComponent = $src$UxAdvancedComponents.URoundButton = function(parent, row) {
		URoundButtonBaseComponent.apply(this, arguments)

	}
	var URoundButtonPrototype = URoundButtonComponent.prototype = Object.create(URoundButtonBasePrototype)

	URoundButtonPrototype.constructor = URoundButtonComponent

	URoundButtonPrototype.componentName = 'src.UxAdvancedComponents.URoundButton'
	URoundButtonPrototype.clicked = $core.createSignal('clicked')
	core.addProperty(URoundButtonPrototype, 'string', 'imageSource', ("Icons/whiteCross.png"))
	core.addProperty(URoundButtonPrototype, 'bool', 'containsMouse', (false))
	core.addProperty(URoundButtonPrototype, 'real', 'imageDecrease', (2))
	core.addProperty(URoundButtonPrototype, 'int', 'verticalOffset', (0))
	core.addProperty(URoundButtonPrototype, 'bool', 'enabled', (true))

	URoundButtonPrototype.$c = function($c) {
		var $this = this;
		URoundButtonBasePrototype.$c.call(this, $c.$b = { })
...
//creating component MouseArea
		...
		_this$child1._setId('ma')
		$this.addChild(_this$child1)
		$this._setId('roundButton')
	}
	URoundButtonPrototype.$s = function($c) {
		var $this = this;
	URoundButtonBasePrototype.$s.call(this, $c.$b); delete $c.$b
//assigning radius to (60)
			$this._removeUpdater('radius'); $this.radius = (60);
//assigning width to (40)
			$this._removeUpdater('width'); $this.width = (40);
//assigning height to (40)
			$this._removeUpdater('height'); $this.height = (40);
//assigning color to ("#F18C16")
			$this._removeUpdater('color'); $this.color = ("#F18C16");
...
//assigning source to (${imageSource})
			_this$child0._replaceUpdater('source', function() { _this$child0.source = (_this$child0.parent.imageSource) }, [_this$child0.parent,'imageSource'])
//assigning anchors.centerIn to (${parent})
			_this$child0.anchors._removeUpdater('centerIn'); _this$child0.anchors.centerIn = (_this$child0.parent);
//assigning anchors.verticalCenterOffset to (${verticalOffset})
			_this$child0.anchors._replaceUpdater('verticalCenterOffset', function() { _this$child0.anchors.verticalCenterOffset = (_this$child0.parent.verticalOffset) }, [_this$child0.parent,'verticalOffset'])
...
//assigning height to (${parent.height} - 10)
			_this$child0._replaceUpdater('height', function() { _this$child0.height = (_this$child0.parent.height - 10) }, [_this$child0.parent,'height'])
//assigning fillMode to (_globals.core.Image.prototype.PreserveAspectFit)
...
//assigning anchors.fill to (${parent})
			_this$child1.anchors._removeUpdater('fill'); _this$child1.anchors.fill = (_this$child1.parent);
//assigning enabled to (${parent.enabled} && ${parent.visible})
			_this$child1._replaceUpdater('enabled', function() { _this$child1.enabled = (_this$child1.parent.enabled && _this$child1.parent.visible) }, [_this$child1.parent,'enabled',_this$child1.parent,'visible'])
//assigning hoverEnabled to (${enabled})
			_this$child1._replaceUpdater('hoverEnabled', function() { _this$child1.hoverEnabled = (_this$child1.enabled) }, [_this$child1,'enabled'])
//assigning cursorShape to (${containsMouse} ? "pointer" : "default")
			_this$child1._replaceUpdater('cursorShape', function() { _this$child1.cursorShape = (_this$child1.containsMouse ? "pointer" : "default") }, [_this$child1,'containsMouse'])
			_this$child1.on('clicked', function() {
	var roundButton = this._get('roundButton', true)

            roundButton.clicked();
        }.bind(_this$child1))
			_this$child1.on('exited', function() {
	var roundButton = this._get('roundButton', true)

            roundButton.containsMouse = false;
        }.bind(_this$child1))
			_this$child1.on('entered', function() {
	var roundButton = this._get('roundButton', true)
	...
	var roundButton = this._get('roundButton', true)
            ...
            roundButton.transform.scale = 0.95;
        }.bind(_this$child1))
			_this$child1.on('mouseReleased', function() {
	var roundButton = this._get('roundButton', true)

            roundButton.transform.scale = 1;
        }.bind(_this$child1))
...
//=====[component core.Flickable]=====================

	var FlickableBaseComponent = $core.BaseView
	var FlickableBasePrototype = FlickableBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.BaseView}
 */
	var FlickableComponent = $core.Flickable = function(parent, row) {
		FlickableBaseComponent.apply(this, arguments)
	//custom constructor:
	{
		this._sizes = []
		this._scrollDelta = 0
	...
	var FlickablePrototype = FlickableComponent.prototype = Object.create(FlickableBasePrototype)

	FlickablePrototype.constructor = FlickableComponent

	FlickablePrototype.componentName = 'core.Flickable'
/** @const @type {number} */
	FlickablePrototype.Vertical = 0
/** @const @type {number} */
	FlickableComponent.Vertical = 0
/** @const @type {number} */
	FlickablePrototype.Horizontal = 1
/** @const @type {number} */
	FlickableComponent.Horizontal = 1
	core.addProperty(FlickablePrototype, 'enum', 'orientation')
	FlickablePrototype._updateOverflow = function() {
		if (!this.nativeScrolling) {
	...
	FlickablePrototype.__complete = function() { FlickableBasePrototype.__complete.call(this)
this._updateOverflow()
}
	FlickablePrototype.move = function(dx,dy) {
		var horizontal = this.orientation === this.Horizontal
		var x, y
	...
	FlickablePrototype.positionViewAtIndex = function(idx) {
		if (this.trace)
	...
	FlickablePrototype._createDelegate = function(idx) {
	...
	FlickablePrototype.getItemPosition = function(idx) {
		var items = this._items
		var item = items[idx]
		if (!item) {
			var x = 0, y = 0, w = 0, h = 0
	...
	FlickablePrototype._layout = function(noPrerender) {
	var model = this._get('model', true)
	...
	FlickablePrototype.indexAt = function(x,y) {
		var items = this._items
		x += this.contentX
		y += this.contentY
	...
	$core._protoOnChanged(FlickablePrototype, 'orientation', function(value) {
		this._updateOverflow()
		this._scheduleLayout()
		this._sizes = []
	})
	$core._protoOnChanged(FlickablePrototype, 'nativeScrolling', function(value) {
		this._updateOverflow()
	})
	$core._protoOnKey(FlickablePrototype, 'Key', function(key,event) {
	...
	FlickablePrototype.$c = function($c) {
		var $this = this;
		FlickableBasePrototype.$c.call(this, $c.$b = { })

	}
	FlickablePrototype.$s = function($c) {
		var $this = this;
	FlickableBasePrototype.$s.call(this, $c.$b); delete $c.$b
$this.completed()
}
...
//=====[component core.Column]=====================
	...
	var ColumnBaseComponent = $core.Layout
 ...
 * @extends {$core.Layout}
 */
	var ColumnComponent = $core.Column = function(parent, row) {
	...
	$core._protoOnKey(ColumnPrototype, 'Key', function(key,event) {
		if (!this.handleNavigationKeys)
			return false;
	...
	ColumnPrototype.$c = function($c) {
		var $this = this;
		ColumnBasePrototype.$c.call(this, $c.$b = { })

	}
	ColumnPrototype.$s = function($c) {
		var $this = this;
	ColumnBasePrototype.$s.call(this, $c.$b); delete $c.$b
$this.completed()
}
...
return exports;
	...
	var context = qml._context = new qml.core.Context(null, false, {id: 'qml-context-start', l10n: l10n, nativeContext: null})
	context.init()
	context.start(new qml.src.UiStart(context))
	context.run()
